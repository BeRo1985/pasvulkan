...
[source,js]
----
let texture = Texture.create("background.png");
...
[source,js]
----
let texture = Texture.create("sprite.png");
...
[source,js]
----
let sprite = Sprite.create("characters.png");
...
[source,js]
----
let sprite = Sprite.create("player.png");
...
[source,js]
----
let sprite = Sprite.create("icon.png");
...
[source,js]
----
let model = Matrix4x4.create();
// Apply transformations to model matrix
canvas.setModelMatrix(model);
