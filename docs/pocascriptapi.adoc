...
==== drawStrokeRoundedRectangle(center, bounds, radius, strokeWidth)
...
// or
canvas.drawStrokeRoundedRectangle(centerX, centerY, boundsX, boundsY, radius, strokeWidth);
----
...
----
// Using Vector2:
canvas.drawStrokeRoundedRectangle(Vector2.create(200, 150), Vector2.create(50, 40), 10, 2.5);

// or using individual numbers:
canvas.drawStrokeRoundedRectangle(200, 150, 50, 40, 10, 2.5);
----
