...
For the base POCA scripting features (Array, Boolean, Console, String, Math, etc.), please refer to the link:../externals/poca/docs/scriptapi.adoc[POCA Script API Documentation].
