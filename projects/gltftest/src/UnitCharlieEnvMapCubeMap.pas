...
type { TCharlieEnvMapCubeMap }
     TCharlieEnvMapCubeMap=class
      public
       const Width=512;
             Height=512;
             Samples=1024;
...
{ TCharlieEnvMapCubeMap }

constructor TCharlieEnvMapCubeMap.Create(const aDescriptorImageInfo:TVkDescriptorImageInfo;const aImageFormat:TVkFormat);
...
begin
 ...
 Stream:=pvApplication.Assets.GetAssetStream('shaders/cubemap_charlie_filter_comp.spv');
 try
...
destructor TCharlieEnvMapCubeMap.Destroy;
begin
