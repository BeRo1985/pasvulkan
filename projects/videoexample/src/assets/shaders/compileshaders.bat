...
rem ('shaders/fvd_composite.frag.spv') in UnitScreenMain (it is NOT embedded into the binary). Run after editing the shader.
if not exist "..\..\..\assets\shaders" mkdir "..\..\..\assets\shaders"
"%VULKAN_SDK%\Bin\glslc.exe" -O --target-env=vulkan -fshader-stage=fragment fvd_composite.frag -o "..\..\..\assets\shaders\fvd_composite.frag.spv"
