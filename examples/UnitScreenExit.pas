...
function TScreenExit.TouchDown(const aScreenX,aScreenY,aPressure:TpvFloat;const aPointerID,aButton:TpvInt32):boolean;
var Index:TpvInt32;
    cy:TpvFloat;
begin
 result:=false;
...
function TScreenExit.TouchUp(const aScreenX,aScreenY,aPressure:TpvFloat;const aPointerID,aButton:TpvInt32):boolean;
begin
 result:=false;
end;

function TScreenExit.TouchDragged(const aScreenX,aScreenY,aPressure:TpvFloat;const aPointerID:TpvInt32):boolean;
var Index:TpvInt32;
    cy:TpvFloat;
begin
 result:=false;
...
function TScreenExit.MouseMoved(const aScreenX,aScreenY:TpvInt32):boolean;
var Index:TpvInt32;
    cy:TpvFloat;
begin
 result:=false;
...
begin
 ...
 ExampleVulkanApplication.TextOverlay.AddText(pvApplication.Width*0.5,ExampleVulkanApplication.TextOverlay.FontCharHeight*1.0,2.0,toaCenter,'Are you sure to exit?');
 fStartY:=(pvApplication.Height-((((ExampleVulkanApplication.TextOverlay.FontCharHeight+4)*FontSize)*2)-(4*FontSize)))*0.5;
 cy:=fStartY;
 for Index:=0 to 1 do begin
