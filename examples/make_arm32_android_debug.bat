...
"c:\FPC\3.1.1\bin\i386-win32\ppcrossarm.exe" -Tandroid -Sd -B -b -g -gl -gw3 -CpARMv7A -CfVFPv3 -OpARMv7a -O- -O1 -XX -Xm -CX -Cg "-olibmain.so" "-FUlib\arm-android" -dDEBUG -dPasVulkanPasMP -dPasVulkanUseSDL2 examples.dpr
