 ...
 *                                                                            *
 ******************************************************************************)
unit PasVulkan.Scene3D.Renderer.Passes.DepthOfFieldCombineRenderPass;
{$i PasVulkan.inc}
{$ifndef fpc}
...
type { TpvScene3DRendererPassesDepthOfFieldCombineRenderPass }
     TpvScene3DRendererPassesDepthOfFieldCombineRenderPass=class(TpvFrameGraph.TRenderPass)
      public
...
{ TpvScene3DRendererPassesDepthOfFieldCombineRenderPass }

constructor TpvScene3DRendererPassesDepthOfFieldCombineRenderPass.Create(const aFrameGraph:TpvFrameGraph;const aInstance:TpvScene3DRendererInstance);
begin
 ...
 Name:='DepthOfFieldCombineRenderPass';
...
destructor TpvScene3DRendererPassesDepthOfFieldCombineRenderPass.Destroy;
begin
 inherited Destroy;
end;

procedure TpvScene3DRendererPassesDepthOfFieldCombineRenderPass.AcquirePersistentResources;
var Stream:TStream;
begin
 ...
 Stream:=pvScene3DShaderVirtualFileSystem.GetFile('dof_combine_frag.spv');
 try
...
procedure TpvScene3DRendererPassesDepthOfFieldCombineRenderPass.ReleasePersistentResources;
begin
...
procedure TpvScene3DRendererPassesDepthOfFieldCombineRenderPass.AcquireVolatileResources;
...
begin
 ...
 fVulkanPipelineLayout.AddPushConstantRange(TVkShaderStageFlags(VK_SHADER_STAGE_FRAGMENT_BIT),0,SizeOf(TpvScene3DRendererPassesDepthOfFieldCombineRenderPass.TPushConstants));
...
procedure TpvScene3DRendererPassesDepthOfFieldCombineRenderPass.ReleaseVolatileResources;
var InFlightFrameIndex:TpvSizeInt;
begin
...
procedure TpvScene3DRendererPassesDepthOfFieldCombineRenderPass.Update(const aUpdateInFlightFrameIndex,aUpdateFrameIndex:TpvSizeInt);
begin
 inherited Update(aUpdateInFlightFrameIndex,aUpdateFrameIndex);
end;

procedure TpvScene3DRendererPassesDepthOfFieldCombineRenderPass.Execute(const aCommandBuffer:TpvVulkanCommandBuffer;const aInFlightFrameIndex,aFrameIndex:TpvSizeInt);
var InFlightFrameState:TpvScene3DRendererInstance.PInFlightFrameState;
    PushConstants:TpvScene3DRendererPassesDepthOfFieldCombineRenderPass.TPushConstants;
begin
 inherited Execute(aCommandBuffer,aInFlightFrameIndex,aFrameIndex);
 InFlightFrameState:=@fInstance.InFlightFrameStates^[aInFlightFrameIndex];
 PushConstants.MaxCoC:=fInstance.CameraPresets[aInFlightFrameIndex].MaxCoC;
 ...
 aCommandBuffer.CmdPushConstants(fVulkanPipelineLayout.Handle,
                                 ...
                                 0,
                                 SizeOf(TpvScene3DRendererPassesDepthOfFieldCombineRenderPass.TPushConstants),
                                 @PushConstants);
