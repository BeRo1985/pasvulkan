 ...
 *                                                                            *
 ******************************************************************************)
unit PasVulkan.Scene3D.Renderer.Passes.WeightBlendedOrderIndependentTransparencyResolveRenderPass;
{$i PasVulkan.inc}
{$ifndef fpc}
...
type { TpvScene3DRendererPassesWeightBlendedOrderIndependentTransparencyResolveRenderPass }
     TpvScene3DRendererPassesWeightBlendedOrderIndependentTransparencyResolveRenderPass=class(TpvFrameGraph.TRenderPass)
       private
...
{ TpvScene3DRendererPassesWeightBlendedOrderIndependentTransparencyResolveRenderPass }

constructor TpvScene3DRendererPassesWeightBlendedOrderIndependentTransparencyResolveRenderPass.Create(const aFrameGraph:TpvFrameGraph;const aInstance:TpvScene3DRendererInstance);
begin
...
destructor TpvScene3DRendererPassesWeightBlendedOrderIndependentTransparencyResolveRenderPass.Destroy;
begin
 inherited Destroy;
end;

procedure TpvScene3DRendererPassesWeightBlendedOrderIndependentTransparencyResolveRenderPass.AcquirePersistentResources;
var Stream:TStream;
begin
 ...
 if fInstance.Scene3D.EnableWater then begin
  if fInstance.Renderer.SurfaceSampleCountFlagBits=TVkSampleCountFlagBits(VK_SAMPLE_COUNT_1_BIT) then begin
   Stream:=pvScene3DShaderVirtualFileSystem.GetFile('wboit_resolve_water_frag.spv');
  end else begin
   if fInstance.Renderer.SupersampleWaterWhenMSAA then begin
    Stream:=pvScene3DShaderVirtualFileSystem.GetFile('wboit_resolve_water_msaa_frag.spv');
   end else begin
    Stream:=pvScene3DShaderVirtualFileSystem.GetFile('wboit_resolve_water_msaa_no_msaa_water_frag.spv');
   end;
  end;
 end else begin
  if fInstance.Renderer.SurfaceSampleCountFlagBits=TVkSampleCountFlagBits(VK_SAMPLE_COUNT_1_BIT) then begin
   Stream:=pvScene3DShaderVirtualFileSystem.GetFile('wboit_resolve_frag.spv');
  end else begin
   Stream:=pvScene3DShaderVirtualFileSystem.GetFile('wboit_resolve_msaa_frag.spv');
  end;
 end;
 try
...
procedure TpvScene3DRendererPassesWeightBlendedOrderIndependentTransparencyResolveRenderPass.ReleasePersistentResources;
begin
...
procedure TpvScene3DRendererPassesWeightBlendedOrderIndependentTransparencyResolveRenderPass.AcquireVolatileResources;
...
begin
 ...
 if fInstance.Scene3D.EnableWater then begin
  fVulkanDescriptorPool.AddDescriptorPoolSize(VK_DESCRIPTOR_TYPE_INPUT_ATTACHMENT,4*fInstance.Renderer.CountInFlightFrames);
 end else begin
...
procedure TpvScene3DRendererPassesWeightBlendedOrderIndependentTransparencyResolveRenderPass.ReleaseVolatileResources;
var InFlightFrameIndex:TpvSizeInt;
begin
...
procedure TpvScene3DRendererPassesWeightBlendedOrderIndependentTransparencyResolveRenderPass.Update(const aUpdateInFlightFrameIndex,aUpdateFrameIndex:TpvSizeInt);
begin
 inherited Update(aUpdateInFlightFrameIndex,aUpdateFrameIndex);
end;

procedure TpvScene3DRendererPassesWeightBlendedOrderIndependentTransparencyResolveRenderPass.Execute(const aCommandBuffer:TpvVulkanCommandBuffer;const aInFlightFrameIndex,aFrameIndex:TpvSizeInt);
begin
 ...
 if assigned(fInstance.Renderer.VulkanDevice.BreadcrumbBuffer) then begin
  fInstance.Renderer.VulkanDevice.BreadcrumbBuffer.BeginBreadcrumb(aCommandBuffer.Handle,TpvVulkanBreadcrumbType.Draw,'WeightBlendedOrderIndependentTransparencyResolveRenderPass');
 end;
