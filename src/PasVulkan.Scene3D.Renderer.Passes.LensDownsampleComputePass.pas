...
begin
 ...
 fVulkanDescriptorPool:=TpvVulkanDescriptorPool.Create(fInstance.Renderer.VulkanDevice,
                                                       ...
                                                       fInstance.Renderer.CountInFlightFrames*fInstance.FullResSceneMipmappedArray2DImages[0].MipMapLevels);
 fVulkanDescriptorPool.AddDescriptorPoolSize(VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER,fInstance.Renderer.CountInFlightFrames*fInstance.FullResSceneMipmappedArray2DImages[0].MipMapLevels);
 fVulkanDescriptorPool.AddDescriptorPoolSize(VK_DESCRIPTOR_TYPE_STORAGE_IMAGE,fInstance.Renderer.CountInFlightFrames*fInstance.FullResSceneMipmappedArray2DImages[0].MipMapLevels);
 ...
 for InFlightFrameIndex:=0 to FrameGraph.CountInFlightFrames-1 do begin
  ...
  for MipMapLevelIndex:=0 to fInstance.FullResSceneMipmappedArray2DImages[InFlightFrameIndex].MipMapLevels-1 do begin
...
begin
 ...
 ImageMemoryBarrier.subresourceRange.levelCount:=fInstance.FullResSceneMipmappedArray2DImages[InFlightFrameIndex].MipMapLevels;
 ...
 for MipMapLevelIndex:=0 to fInstance.FullResSceneMipmappedArray2DImages[InFlightFrameIndex].MipMapLevels-1 do begin
  ...
  ImageMemoryBarrier.subresourceRange.baseArrayLayer:=0;
  ImageMemoryBarrier.subresourceRange.layerCount:=fInstance.CountSurfaceViews;
  if (MipMapLevelIndex+1)<fInstance.FullResSceneMipmappedArray2DImages[InFlightFrameIndex].MipMapLevels then begin
