 ...
 *                                                                            *
 ******************************************************************************)
unit PasVulkan.Scene3D.Renderer.Passes.AntialiasingDSAARenderPass;
{$i PasVulkan.inc}
{$ifndef fpc}
...
procedure TpvScene3DRendererPassesAntialiasingDSAARenderPass.AcquirePersistentResources;
var Stream:TStream;
begin
 ...
 Stream:=pvScene3DShaderVirtualFileSystem.GetFile('antialiasing_dsaa_frag.spv');
 try
...
procedure TpvScene3DRendererPassesAntialiasingDSAARenderPass.ReleasePersistentResources;
begin
...
procedure TpvScene3DRendererPassesAntialiasingDSAARenderPass.AcquireVolatileResources;
...
procedure TpvScene3DRendererPassesAntialiasingDSAARenderPass.ReleaseVolatileResources;
var InFlightFrameIndex:TpvSizeInt;
begin
