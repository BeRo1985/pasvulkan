...
void main(){
  ...
  vec4 colorA = fma(textureLod(uTextureInputs[0], uvw, 0.0), vec2(1.0, 2.0).xxxy, vec2(1.0, -1.0).xxxy);
  //vec4 colorB = fma(textureLod(uTextureInputs[1], uvw, 0.0), vec2(1.0, 2.0).xxxy, vec2(1.0, -1.0).xxxy);
