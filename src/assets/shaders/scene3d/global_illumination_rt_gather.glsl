...
#define GI_TRACE_BACKEND_RSM      2  // non-raytraced Reflective Shadow Map gather; its giTraceClosestHit is provided by the includer (global_illumination_dugi_trace.comp)
