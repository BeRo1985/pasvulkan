...
compileshaderarguments=(
  ...
  "-V planet_renderpass.vert -DUSE_BUFFER_REFERENCE -DTRIANGLES -o ${tempPath}/planet_renderpass_bufref_triangles_vert.spv"
  "-V planet_renderpass.vert -DUSE_BUFFER_REFERENCE -DTRIANGLES -DVELOCITY -o ${tempPath}/planet_renderpass_bufref_triangles_velocity_vert.spv"
  "-V planet_renderpass.vert -DUSE_BUFFER_REFERENCE -DOCTAHEDRAL -o ${tempPath}/planet_renderpass_bufref_octahedral_vert.spv"
  "-V planet_renderpass.vert -DUSE_BUFFER_REFERENCE -DOCTAHEDRAL -DVELOCITY -o ${tempPath}/planet_renderpass_bufref_octahedral_velocity_vert.spv"
  "-V planet_renderpass.vert -DUSE_BUFFER_REFERENCE -DOCTAHEDRAL -DTRIANGLES -o ${tempPath}/planet_renderpass_bufref_octahedral_triangles_vert.spv"
  "-V planet_renderpass.vert -DUSE_BUFFER_REFERENCE -DOCTAHEDRAL -DTRIANGLES -DVELOCITY -o ${tempPath}/planet_renderpass_bufref_octahedral_triangles_velocity_vert.spv"
  "-V planet_renderpass.vert -DUSE_BUFFER_REFERENCE -DICOSAHEDRAL -DTRIANGLES -o ${tempPath}/planet_renderpass_bufref_icosahedral_triangles_vert.spv"
  "-V planet_renderpass.vert -DUSE_BUFFER_REFERENCE -DICOSAHEDRAL -DTRIANGLES -DVELOCITY -o ${tempPath}/planet_renderpass_bufref_icosahedral_triangles_velocity_vert.spv"
  "-V planet_renderpass.vert -DUSE_BUFFER_REFERENCE -DEXTERNAL_VERTICES -o ${tempPath}/planet_renderpass_bufref_external_vert.spv"
  "-V planet_renderpass.vert -DUSE_BUFFER_REFERENCE -DEXTERNAL_VERTICES -DVELOCITY -o ${tempPath}/planet_renderpass_bufref_external_velocity_vert.spv"
  "-V planet_renderpass.vert -DUSE_BUFFER_REFERENCE -DDIRECT -o ${tempPath}/planet_renderpass_bufref_direct_vert.spv"
  "-V planet_renderpass.vert -DUSE_BUFFER_REFERENCE -DDIRECT -DVELOCITY -o ${tempPath}/planet_renderpass_bufref_direct_velocity_vert.spv"
  "-V planet_renderpass.vert -DUSE_BUFFER_REFERENCE -DDIRECT -DTRIANGLES -o ${tempPath}/planet_renderpass_bufref_direct_triangles_vert.spv"
  "-V planet_renderpass.vert -DUSE_BUFFER_REFERENCE -DDIRECT -DTRIANGLES -DVELOCITY -o ${tempPath}/planet_renderpass_bufref_direct_triangles_velocity_vert.spv"
  "-V planet_renderpass.vert -DUSE_BUFFER_REFERENCE -DDIRECT -DOCTAHEDRAL -o ${tempPath}/planet_renderpass_bufref_direct_octahedral_vert.spv"
  "-V planet_renderpass.vert -DUSE_BUFFER_REFERENCE -DDIRECT -DOCTAHEDRAL -DVELOCITY -o ${tempPath}/planet_renderpass_bufref_direct_octahedral_velocity_vert.spv"
  "-V planet_renderpass.vert -DUSE_BUFFER_REFERENCE -DDIRECT -DOCTAHEDRAL -DTRIANGLES -o ${tempPath}/planet_renderpass_bufref_direct_octahedral_triangles_vert.spv"
  "-V planet_renderpass.vert -DUSE_BUFFER_REFERENCE -DDIRECT -DOCTAHEDRAL -DTRIANGLES -DVELOCITY -o ${tempPath}/planet_renderpass_bufref_direct_octahedral_triangles_velocity_vert.spv"
  "-V planet_renderpass.vert -DUSE_BUFFER_REFERENCE -DDIRECT -DICOSAHEDRAL -DTRIANGLES -o ${tempPath}/planet_renderpass_bufref_direct_icosahedral_triangles_vert.spv"
  "-V planet_renderpass.vert -DUSE_BUFFER_REFERENCE -DDIRECT -DICOSAHEDRAL -DTRIANGLES -DVELOCITY -o ${tempPath}/planet_renderpass_bufref_direct_icosahedral_triangles_velocity_vert.spv"
  "-V planet_renderpass.vert -DUSE_BUFFER_REFERENCE -DDIRECT -DEXTERNAL_VERTICES -o ${tempPath}/planet_renderpass_bufref_direct_external_vert.spv"
  "-V planet_renderpass.vert -DUSE_BUFFER_REFERENCE -DDIRECT -DEXTERNAL_VERTICES -DVELOCITY -o ${tempPath}/planet_renderpass_bufref_direct_external_velocity_vert.spv"
  ...
  "-V planet_renderpass.tesc -DUSE_BUFFER_REFERENCE -o ${tempPath}/planet_renderpass_bufref_tesc.spv"
  "-V planet_renderpass.tesc -DUSE_BUFFER_REFERENCE -DVELOCITY -o ${tempPath}/planet_renderpass_bufref_velocity_tesc.spv"
  "-V planet_renderpass.tesc -DUSE_BUFFER_REFERENCE -DTRIANGLES -o ${tempPath}/planet_renderpass_bufref_triangles_tesc.spv"
  "-V planet_renderpass.tesc -DUSE_BUFFER_REFERENCE -DTRIANGLES -DVELOCITY -o ${tempPath}/planet_renderpass_bufref_triangles_velocity_tesc.spv"
  ...
  "-V planet_renderpass.tese -DUSE_BUFFER_REFERENCE -o ${tempPath}/planet_renderpass_bufref_tese.spv"
  "-V planet_renderpass.tese -DUSE_BUFFER_REFERENCE -DVELOCITY -o ${tempPath}/planet_renderpass_bufref_velocity_tese.spv"
  "-V planet_renderpass.tese -DUSE_BUFFER_REFERENCE -DTRIANGLES -o ${tempPath}/planet_renderpass_bufref_triangles_tese.spv"
  "-V planet_renderpass.tese -DUSE_BUFFER_REFERENCE -DTRIANGLES -DVELOCITY -o ${tempPath}/planet_renderpass_bufref_triangles_velocity_tese.spv"
  ...
  "-V planet_renderpass.frag -DUSE_BUFFER_REFERENCE -DVELOCITY -DEXTERNAL_VERTICES -o ${tempPath}/planet_renderpass_bufref_velocity_external_frag.spv"
  ...
  "-V planet_renderpass.frag -DUSE_BUFFER_REFERENCE -DWIREFRAME -DEXTERNAL_VERTICES -o ${tempPath}/planet_renderpass_bufref_wireframe_external_frag.spv"
  ...
  "-V planet_renderpass.frag -DMSM -DUSE_BUFFER_REFERENCE -DVELOCITY -DEXTERNAL_VERTICES -o ${tempPath}/planet_renderpass_bufref_velocity_external_msm_frag.spv"
  ...
  "-V planet_renderpass.frag -DMSM -DUSE_BUFFER_REFERENCE -DWIREFRAME -DEXTERNAL_VERTICES -o ${tempPath}/planet_renderpass_bufref_wireframe_external_msm_frag.spv"
  ...
  "-V planet_renderpass.frag -DMSM -DRAYTRACING -DVELOCITY -DEXTERNAL_VERTICES -o ${tempPath}/planet_renderpass_raytracing_velocity_external_msm_frag.spv"
  ...
  "-V planet_renderpass.frag -DMSM -DRAYTRACING -DWIREFRAME -DEXTERNAL_VERTICES -o ${tempPath}/planet_renderpass_raytracing_wireframe_external_msm_frag.spv"
  "-V planet_renderpass.frag -DMSM -DRAYTRACING -DWIREFRAME -DVELOCITY -DEXTERNAL_VERTICES -o ${tempPath}/planet_renderpass_raytracing_wireframe_velocity_external_msm_frag.spv"
  ...
  "-V planet_renderpass.frag -DPCFPCSS -DUSE_BUFFER_REFERENCE -DVELOCITY -DEXTERNAL_VERTICES -o ${tempPath}/planet_renderpass_bufref_velocity_external_pcfpcss_frag.spv"
  ...
  "-V planet_renderpass.frag -DPCFPCSS -DUSE_BUFFER_REFERENCE -DWIREFRAME -DEXTERNAL_VERTICES -o ${tempPath}/planet_renderpass_bufref_wireframe_external_pcfpcss_frag.spv"
