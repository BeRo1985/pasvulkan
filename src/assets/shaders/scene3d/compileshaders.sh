...
compileshaderarguments=(
  ...
  "-V planet_water_interpolate.comp -o ${tempPath}/planet_water_interpolate_comp.spv"

  "-V planet_water_transfer.comp -DOUTFLOW -o ${tempPath}/planet_water_transfer_comp.spv"
