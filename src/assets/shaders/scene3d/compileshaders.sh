...
# "-V planet_water_simulation.comp -DOUTFLOW -o ${tempPath}/planet_water_simulation_pass2_comp.spv"
  ...
  "-V planet_water_simulation_velocity.comp -o ${tempPath}/planet_water_simulation_pass1_comp.spv"
  "-V planet_water_simulation_outflow.comp -o ${tempPath}/planet_water_simulation_pass2_comp.spv"
