...
compileshaderarguments=(
  ...
  "-V downsample_depth.comp --target-env vulkan1.2 -DFIRSTPASS -o ${tempPath}/downsample_depth_firstpass_comp.spv"
  "-V downsample_depth.comp --target-env vulkan1.2 -DFIRSTPASS -DREVERSEDZ -o ${tempPath}/downsample_depth_reversedz_firstpass_comp.spv"
  "-V downsample_depth.comp --target-env vulkan1.2 -DFIRSTPASS -DMSAA -o ${tempPath}/downsample_depth_msaa_firstpass_comp.spv"
  "-V downsample_depth.comp --target-env vulkan1.2 -DFIRSTPASS -DMSAA -DREVERSEDZ -o ${tempPath}/downsample_depth_msaa_reversedz_firstpass_comp.spv"
  "-V downsample_depth.comp --target-env vulkan1.2 -DFIRSTPASS -DMULTIVIEW -o ${tempPath}/downsample_depth_multiview_firstpass_comp.spv"
  "-V downsample_depth.comp --target-env vulkan1.2 -DFIRSTPASS -DMULTIVIEW -DREVERSEDZ -o ${tempPath}/downsample_depth_multiview_reversedz_firstpass_comp.spv"
  "-V downsample_depth.comp --target-env vulkan1.2 -DFIRSTPASS -DMULTIVIEW -DMSAA -o ${tempPath}/downsample_depth_multiview_msaa_firstpass_comp.spv"
  "-V downsample_depth.comp --target-env vulkan1.2 -DFIRSTPASS -DMULTIVIEW -DMSAA -DREVERSEDZ -o ${tempPath}/downsample_depth_multiview_msaa_reversedz_firstpass_comp.spv"
  "-V downsample_depth.comp --target-env vulkan1.2 -DREDUCTION -o ${tempPath}/downsample_depth_reduction_comp.spv"
  "-V downsample_depth.comp --target-env vulkan1.2 -DREDUCTION -DMULTIVIEW -o ${tempPath}/downsample_depth_multiview_reduction_comp.spv"
  "-V downsample_depth.comp --target-env vulkan1.2 -DREDUCTION -DREVERSEDZ -o ${tempPath}/downsample_depth_reversedz_reduction_comp.spv"
  "-V downsample_depth.comp --target-env vulkan1.2 -DREDUCTION -DMULTIVIEW -DREVERSEDZ -o ${tempPath}/downsample_depth_multiview_reversedz_reduction_comp.spv"
  ...
  "-V cubemap_gradient.comp -o ${tempPath}/cubemap_gradient_comp.spv"
  "-V cubemap_gradient.comp -DUSE_RGB9E5 -o ${tempPath}/cubemap_gradient_rgb9e5_comp.spv"
  "-V cubemap_gradient.comp -DUSE_R11G11B10F -o ${tempPath}/cubemap_gradient_r11g11b10f_comp.spv"
  "-V cubemap_gradient.comp -DUSE_RGBA16F -o ${tempPath}/cubemap_gradient_rgba16f_comp.spv"
  "-V cubemap_gradient.comp -DUSE_RGBA32F -o ${tempPath}/cubemap_gradient_rgba32f_comp.spv"
  "-V cubemap_gradient.comp -DUSE_RGBA8 -o ${tempPath}/cubemap_gradient_rgba8_comp.spv"
...
#  "-V planet_water_simulation.comp -o ${tempPath}/planet_water_simulation_waterheight_comp.spv"
  ...
  # Atmosphere
  "-V atmosphere_map_scan.comp --target-env vulkan1.2 -o ${tempPath}/atmosphere_map_scan_comp.spv"
