...
compileshaderarguments=(
  ...
  "-V atmosphere_clouds_raymarch.frag -DDUALBLEND -o ${tempPath}/atmosphere_clouds_raymarch_dualblend_frag.spv"
  "-V atmosphere_clouds_raymarch.frag -DDUALBLEND -DMSAA -o ${tempPath}/atmosphere_clouds_raymarch_dualblend_msaa_frag.spv"
  "-V atmosphere_clouds_raymarch.frag -DDUALBLEND -DMULTIVIEW -o ${tempPath}/atmosphere_clouds_raymarch_dualblend_multiview_frag.spv"
  "-V atmosphere_clouds_raymarch.frag -DDUALBLEND -DMULTIVIEW -DMSAA -o ${tempPath}/atmosphere_clouds_raymarch_dualblend_multiview_msaa_frag.spv"
  ...
  "-V atmosphere_clouds_raymarch.frag -DSHADOWS -DMSM -DDUALBLEND -o ${tempPath}/atmosphere_clouds_raymarch_shadows_msm_dualblend_frag.spv"
  "-V atmosphere_clouds_raymarch.frag -DSHADOWS -DMSM -DDUALBLEND -DMSAA -o ${tempPath}/atmosphere_clouds_raymarch_shadows_msm_dualblend_msaa_frag.spv"
  "-V atmosphere_clouds_raymarch.frag -DSHADOWS -DMSM -DDUALBLEND -DMULTIVIEW -o ${tempPath}/atmosphere_clouds_raymarch_shadows_msm_dualblend_multiview_frag.spv"
  "-V atmosphere_clouds_raymarch.frag -DSHADOWS -DMSM -DDUALBLEND -DMULTIVIEW -DMSAA -o ${tempPath}/atmosphere_clouds_raymarch_shadows_msm_dualblend_multiview_msaa_frag.spv"
  ...
  "-V atmosphere_clouds_raymarch.frag -DSHADOWS -DPCFPCSS -DDUALBLEND -o ${tempPath}/atmosphere_clouds_raymarch_shadows_pcfpcss_dualblend_frag.spv"
  "-V atmosphere_clouds_raymarch.frag -DSHADOWS -DPCFPCSS -DDUALBLEND -DMSAA -o ${tempPath}/atmosphere_clouds_raymarch_shadows_pcfpcss_dualblend_msaa_frag.spv"
  "-V atmosphere_clouds_raymarch.frag -DSHADOWS -DPCFPCSS -DDUALBLEND -DMULTIVIEW -o ${tempPath}/atmosphere_clouds_raymarch_shadows_pcfpcss_dualblend_multiview_frag.spv"
  "-V atmosphere_clouds_raymarch.frag -DSHADOWS -DPCFPCSS -DDUALBLEND -DMULTIVIEW -DMSAA -o ${tempPath}/atmosphere_clouds_raymarch_shadows_pcfpcss_dualblend_multiview_msaa_frag.spv"
  ...
  "-V atmosphere_clouds_raymarch.frag --target-env vulkan1.2 -DSHADOWS -DRAYTRACING -DDUALBLEND -o ${tempPath}/atmosphere_clouds_raymarch_shadows_raytracing_dualblend_frag.spv"
  "-V atmosphere_clouds_raymarch.frag --target-env vulkan1.2 -DSHADOWS -DRAYTRACING -DDUALBLEND -DMSAA -o ${tempPath}/atmosphere_clouds_raymarch_shadows_raytracing_dualblend_msaa_frag.spv"
  "-V atmosphere_clouds_raymarch.frag --target-env vulkan1.2 -DSHADOWS -DRAYTRACING -DDUALBLEND -DMULTIVIEW -o ${tempPath}/atmosphere_clouds_raymarch_shadows_raytracing_dualblend_multiview_frag.spv"
  "-V atmosphere_clouds_raymarch.frag --target-env vulkan1.2 -DSHADOWS -DRAYTRACING -DDUALBLEND -DMULTIVIEW -DMSAA -o ${tempPath}/atmosphere_clouds_raymarch_shadows_raytracing_dualblend_multiview_msaa_frag.spv"
