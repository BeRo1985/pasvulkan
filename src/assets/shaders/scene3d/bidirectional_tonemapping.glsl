...
#define BIDIRECTIONAL_TONEMAPPING_VARIANT_NONE 0
#define BIDIRECTIONAL_TONEMAPPING_VARIANT_ACES 1
#define BIDIRECTIONAL_TONEMAPPING_VARIANT_AMD 2
#define BIDIRECTIONAL_TONEMAPPING_VARIANT_BRIAN_KARIS 3
#define BIDIRECTIONAL_TONEMAPPING_VARIANT_JIM_HEJL_RICHARD_BURGESS_DAWSON 4
#define BIDIRECTIONAL_TONEMAPPING_VARIANT_UNCHARTED2 5
