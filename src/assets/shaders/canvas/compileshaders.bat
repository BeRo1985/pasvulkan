...
"%VULKAN_SDK%/Bin/glslc.exe" -x glsl --target-env=vulkan -fshader-stage=vertex -DUSECLIPDISTANCE=0 -o canvas_vert.spv canvas.vert
...
"%VULKAN_SDK%/Bin/glslc.exe" -x glsl --target-env=vulkan -fshader-stage=vertex -DUSECLIPDISTANCE=1 -o canvas_vert_clip_distance.spv canvas.vert
