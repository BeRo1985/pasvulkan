...
"%VULKAN_SDK%/Bin32/glslc.exe" -x glsl --target-env=vulkan -fshader-stage=fragment -DFILLTYPE=%FILLTYPE_NO_TEXTURE% -DGUI_ELEMENTS -o canvas_frag_gui_no_texture.spv canvas.frag
