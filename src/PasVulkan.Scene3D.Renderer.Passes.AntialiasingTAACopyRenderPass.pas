 ...
 *                                                                            *
 ******************************************************************************)
unit PasVulkan.Scene3D.Renderer.Passes.AntialiasingTAACopyRenderPass;
{$i PasVulkan.inc}
{$ifndef fpc}
...
type { TpvScene3DRendererPassesAntialiasingTAACopyRenderPass }
      TpvScene3DRendererPassesAntialiasingTAACopyRenderPass=class(TpvFrameGraph.TRenderPass)
       private
...
{ TpvScene3DRendererPassesAntialiasingTAACopyRenderPass }

constructor TpvScene3DRendererPassesAntialiasingTAACopyRenderPass.Create(const aFrameGraph:TpvFrameGraph;const aInstance:TpvScene3DRendererInstance);
begin
...
destructor TpvScene3DRendererPassesAntialiasingTAACopyRenderPass.Destroy;
begin
 inherited Destroy;
end;

procedure TpvScene3DRendererPassesAntialiasingTAACopyRenderPass.AcquirePersistentResources;
var Stream:TStream;
begin
 ...
 Stream:=pvScene3DShaderVirtualFileSystem.GetFile('blit_frag.spv');
 try
...
procedure TpvScene3DRendererPassesAntialiasingTAACopyRenderPass.ReleasePersistentResources;
begin
...
procedure TpvScene3DRendererPassesAntialiasingTAACopyRenderPass.AcquireVolatileResources;
...
procedure TpvScene3DRendererPassesAntialiasingTAACopyRenderPass.ReleaseVolatileResources;
var InFlightFrameIndex:TpvSizeInt;
begin
...
procedure TpvScene3DRendererPassesAntialiasingTAACopyRenderPass.Update(const aUpdateInFlightFrameIndex,aUpdateFrameIndex:TpvSizeInt);
begin
 inherited Update(aUpdateInFlightFrameIndex,aUpdateFrameIndex);
end;

procedure TpvScene3DRendererPassesAntialiasingTAACopyRenderPass.Execute(const aCommandBuffer:TpvVulkanCommandBuffer;const aInFlightFrameIndex,aFrameIndex:TpvSizeInt);
begin
