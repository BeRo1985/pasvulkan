 ...
 *                                                                            *
 ******************************************************************************)
unit PasVulkan.Scene3D.Renderer.Passes.DepthOfFieldBlurRenderPass;
{$i PasVulkan.inc}
{$ifndef fpc}
...
type { TpvScene3DRendererPassesDepthOfFieldBlurRenderPass }
     TpvScene3DRendererPassesDepthOfFieldBlurRenderPass=class(TpvFrameGraph.TRenderPass)
      public
...
begin
 ...
 Name:='DepthOfFieldBlurRenderPass';
...
destructor TpvScene3DRendererPassesDepthOfFieldBlurRenderPass.Destroy;
begin
 inherited Destroy;
end;
...
begin
 ...
 Stream:=pvScene3DShaderVirtualFileSystem.GetFile('dof_blur_frag.spv');
 try
...
procedure TpvScene3DRendererPassesDepthOfFieldBlurRenderPass.ReleasePersistentResources;
begin
...
procedure TpvScene3DRendererPassesDepthOfFieldBlurRenderPass.AcquireVolatileResources;
...
begin
 ...
 fVulkanPipelineLayout.AddPushConstantRange(TVkShaderStageFlags(VK_SHADER_STAGE_FRAGMENT_BIT),0,SizeOf(TpvScene3DRendererPassesDepthOfFieldBlurRenderPass.TPushConstants));
...
procedure TpvScene3DRendererPassesDepthOfFieldBlurRenderPass.ReleaseVolatileResources;
var InFlightFrameIndex:TpvSizeInt;
begin
...
procedure TpvScene3DRendererPassesDepthOfFieldBlurRenderPass.Update(const aUpdateInFlightFrameIndex,aUpdateFrameIndex:TpvSizeInt);
begin
...
//InFlightFrameState:=@fInstance.InFlightFrameStates^[aInFlightFrameIndex];
 ...
 aCommandBuffer.CmdPushConstants(fVulkanPipelineLayout.Handle,
                                 ...
                                 0,
                                 SizeOf(TpvScene3DRendererPassesDepthOfFieldBlurRenderPass.TPushConstants),
                                 @PushConstants);
