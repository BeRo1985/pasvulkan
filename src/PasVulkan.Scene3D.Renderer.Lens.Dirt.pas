 ...
 *                                                                            *
 ******************************************************************************)
unit PasVulkan.Scene3D.Renderer.Lens.Dirt;
{$i PasVulkan.inc}
{$ifndef fpc}
...
type { TpvScene3DRendererLensDirt }
     TpvScene3DRendererLensDirt=class
      public
       const Width=2048;
             Height=2048;
...
begin
 ...
 Stream:=pvScene3DShaderVirtualFileSystem.GetFile('lens_dirt_frag.spv');
 try
 ...
 aVulkanDevice.DebugUtils.SetObjectName(fVulkanImage.Handle,VK_OBJECT_TYPE_IMAGE,'LensDirt.Image');
  ...
  try
   ...
   try
    ...
    fVulkanImageView:=TpvVulkanImageView.Create(aVulkanDevice,
                                                ...
                                                0,
                                                1);
    aVulkanDevice.DebugUtils.SetObjectName(fVulkanImageView.Handle,VK_OBJECT_TYPE_IMAGE_VIEW,'LensDirt.ImageView');
...
destructor TpvScene3DRendererLensDirt.Destroy;
begin
