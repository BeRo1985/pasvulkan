...
type { TpvScene3DRendererInstancePassesLoopOrderIndependentTransparencyPass1RenderPass }
     TpvScene3DRendererInstancePassesLoopOrderIndependentTransparencyPass1RenderPass=class(TpvFrameGraph.TRenderPass)
      private
...
{ TpvScene3DRendererInstancePassesLoopOrderIndependentTransparencyPass1RenderPass }

constructor TpvScene3DRendererInstancePassesLoopOrderIndependentTransparencyPass1RenderPass.Create(const aFrameGraph:TpvFrameGraph;const aInstance:TpvScene3DRendererInstance);
begin
...
destructor TpvScene3DRendererInstancePassesLoopOrderIndependentTransparencyPass1RenderPass.Destroy;
begin
 inherited Destroy;
end;

procedure TpvScene3DRendererInstancePassesLoopOrderIndependentTransparencyPass1RenderPass.Show;
...
//fFrameGraph.VulkanDevice.DebugMarker.SetObjectName(fMeshVertexShaderModule.Handle,TVkDebugReportObjectTypeEXT.VK_DEBUG_REPORT_OBJECT_TYPE_SHADER_MODULE_EXT,'fMeshVertexShaderModule');
 ...
 if fInstance.Renderer.SurfaceSampleCountFlagBits=TVkSampleCountFlagBits(VK_SAMPLE_COUNT_1_BIT) then begin
  if fInstance.ZFar<0.0 then begin
   Stream:=pvApplication.Assets.GetAssetStream('shaders/mesh_'+fInstance.Renderer.MeshFragTypeName+'_'+fInstance.Renderer.MeshFragShadowTypeName+'_loopoit_reversedz_pass1_frag.spv');
  end else begin
   Stream:=pvApplication.Assets.GetAssetStream('shaders/mesh_'+fInstance.Renderer.MeshFragTypeName+'_'+fInstance.Renderer.MeshFragShadowTypeName+'_loopoit_pass1_frag.spv');
  end;
 end else begin
  if fInstance.ZFar<0.0 then begin
   Stream:=pvApplication.Assets.GetAssetStream('shaders/mesh_'+fInstance.Renderer.MeshFragTypeName+'_'+fInstance.Renderer.MeshFragShadowTypeName+'_loopoit_msaa_reversedz_pass1_frag.spv');
  end else begin
...
//fFrameGraph.VulkanDevice.DebugMarker.SetObjectName(fMeshFragmentShaderModule.Handle,TVkDebugReportObjectTypeEXT.VK_DEBUG_REPORT_OBJECT_TYPE_SHADER_MODULE_EXT,'fMeshFragmentShaderModule');
 ...
 if fInstance.Renderer.SurfaceSampleCountFlagBits=TVkSampleCountFlagBits(VK_SAMPLE_COUNT_1_BIT) then begin
  if fInstance.ZFar<0.0 then begin
   Stream:=pvApplication.Assets.GetAssetStream('shaders/mesh_'+fInstance.Renderer.MeshFragTypeName+'_'+fInstance.Renderer.MeshFragShadowTypeName+'_loopoit_masked_reversedz_pass1_frag.spv');
  end else begin
   Stream:=pvApplication.Assets.GetAssetStream('shaders/mesh_'+fInstance.Renderer.MeshFragTypeName+'_'+fInstance.Renderer.MeshFragShadowTypeName+'_loopoit_masked_pass1_frag.spv');
  end;
 end else begin
  if fInstance.ZFar<0.0 then begin
   Stream:=pvApplication.Assets.GetAssetStream('shaders/mesh_'+fInstance.Renderer.MeshFragTypeName+'_'+fInstance.Renderer.MeshFragShadowTypeName+'_loopoit_msaa_masked_reversedz_pass1_frag.spv');
  end else begin
   Stream:=pvApplication.Assets.GetAssetStream('shaders/mesh_'+fInstance.Renderer.MeshFragTypeName+'_'+fInstance.Renderer.MeshFragShadowTypeName+'_loopoit_msaa_masked_pass1_frag.spv');
  end;
 end;
 try
...
procedure TpvScene3DRendererInstancePassesLoopOrderIndependentTransparencyPass1RenderPass.Hide;
begin
...
procedure TpvScene3DRendererInstancePassesLoopOrderIndependentTransparencyPass1RenderPass.AfterCreateSwapChain;
...
procedure TpvScene3DRendererInstancePassesLoopOrderIndependentTransparencyPass1RenderPass.BeforeDestroySwapChain;
var Index:TpvSizeInt;
    AlphaMode:TpvScene3D.TMaterial.TAlphaMode;
    PrimitiveTopology:TpvScene3D.TPrimitiveTopology;
    DoubleSided:TpvScene3D.TDoubleSided;
...
procedure TpvScene3DRendererInstancePassesLoopOrderIndependentTransparencyPass1RenderPass.Update(const aUpdateInFlightFrameIndex,aUpdateFrameIndex:TpvSizeInt);
begin
 inherited Update(aUpdateInFlightFrameIndex,aUpdateFrameIndex);
end;

procedure TpvScene3DRendererInstancePassesLoopOrderIndependentTransparencyPass1RenderPass.OnSetRenderPassResources(const aCommandBuffer:TpvVulkanCommandBuffer;
                                                                                                const aPipelineLayout:TpvVulkanPipelineLayout;
                                                                                                const aRenderPassIndex:TpvSizeInt;
                                                                                                const aPreviousInFlightFrameIndex:TpvSizeInt;
                                                                                                const aInFlightFrameIndex:TpvSizeInt);
...
procedure TpvScene3DRendererInstancePassesLoopOrderIndependentTransparencyPass1RenderPass.Execute(const aCommandBuffer:TpvVulkanCommandBuffer;
