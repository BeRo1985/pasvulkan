 ...
 *                                                                            *
 ******************************************************************************)
unit PasVulkan.Scene3D.Renderer.Passes.AtmosphereCloudShadowRenderPass;
{$i PasVulkan.inc}
{$ifndef fpc}
...
type { TpvScene3DRendererPassesAtmosphereCloudShadowRenderPass }
     TpvScene3DRendererPassesAtmosphereCloudShadowRenderPass=class(TpvFrameGraph.TRenderPass)
      public
      private
...
{ TpvScene3DRendererPassesAtmosphereCloudShadowRenderPass }

constructor TpvScene3DRendererPassesAtmosphereCloudShadowRenderPass.Create(const aFrameGraph:TpvFrameGraph;const aInstance:TpvScene3DRendererInstance);
begin
 ...
 Name:='AtmosphereCloudShadowRenderPass';
...
destructor TpvScene3DRendererPassesAtmosphereCloudShadowRenderPass.Destroy;
begin
 inherited Destroy;
end;

procedure TpvScene3DRendererPassesAtmosphereCloudShadowRenderPass.AcquirePersistentResources;
var Stream:TStream;
begin
 ...
 Stream:=pvScene3DShaderVirtualFileSystem.GetFile('atmosphere_clouds_raymarch_clouds_shadowmap_frag.spv');
 try
...
procedure TpvScene3DRendererPassesAtmosphereCloudShadowRenderPass.ReleasePersistentResources;
begin
...
procedure TpvScene3DRendererPassesAtmosphereCloudShadowRenderPass.AcquireVolatileResources;
begin
...
procedure TpvScene3DRendererPassesAtmosphereCloudShadowRenderPass.ReleaseVolatileResources;
begin
...
procedure TpvScene3DRendererPassesAtmosphereCloudShadowRenderPass.Update(const aUpdateInFlightFrameIndex,aUpdateFrameIndex:TpvSizeInt);
begin
 inherited Update(aUpdateInFlightFrameIndex,aUpdateFrameIndex);
end;

procedure TpvScene3DRendererPassesAtmosphereCloudShadowRenderPass.Execute(const aCommandBuffer:TpvVulkanCommandBuffer;const aInFlightFrameIndex,aFrameIndex:TpvSizeInt);
...
begin
 ...
 fPushConstants.BaseViewIndex:=InFlightFrameState^.CloudsShadowMapViewIndex;
 fPushConstants.CountViews:=1;
