 ...
 *                                                                            *
 ******************************************************************************)
unit PasVulkan.Scene3D.Renderer.Passes.GlobalIlluminationCascadedVoxelConeTracingVisualVoxelizationRenderPass;
{$i PasVulkan.inc}
{$ifndef fpc}
...
type { TpvScene3DRendererPassesGlobalIlluminationCascadedVoxelConeTracingVisualVoxelizationRenderPass }
     TpvScene3DRendererPassesGlobalIlluminationCascadedVoxelConeTracingVisualVoxelizationRenderPass=class(TpvFrameGraph.TRenderPass)
      private
...
{ TpvScene3DRendererPassesGlobalIlluminationCascadedVoxelConeTracingVisualVoxelizationRenderPass }

constructor TpvScene3DRendererPassesGlobalIlluminationCascadedVoxelConeTracingVisualVoxelizationRenderPass.Create(const aFrameGraph:TpvFrameGraph;const aInstance:TpvScene3DRendererInstance);
begin
inherited Create(aFrameGraph);

 fInstance:=aInstance;

 Name:='GlobalIlluminationCascadedVoxelConeTracingVisualVoxelizationRenderPass';
...
destructor TpvScene3DRendererPassesGlobalIlluminationCascadedVoxelConeTracingVisualVoxelizationRenderPass.Destroy;
begin
 inherited Destroy;
end;

procedure TpvScene3DRendererPassesGlobalIlluminationCascadedVoxelConeTracingVisualVoxelizationRenderPass.AcquirePersistentResources;
...
procedure TpvScene3DRendererPassesGlobalIlluminationCascadedVoxelConeTracingVisualVoxelizationRenderPass.ReleasePersistentResources;
begin
...
procedure TpvScene3DRendererPassesGlobalIlluminationCascadedVoxelConeTracingVisualVoxelizationRenderPass.AcquireVolatileResources;
...
begin
 ...
 fGlobalVulkanDescriptorPool.AddDescriptorPoolSize(VK_DESCRIPTOR_TYPE_STORAGE_BUFFER,4*fInstance.Renderer.CountInFlightFrames);
 ...
 fGlobalVulkanDescriptorSets[InFlightFrameIndex].WriteToDescriptorSet(0,
  ...
  fGlobalVulkanDescriptorSets[InFlightFrameIndex].WriteToDescriptorSet(4,
                                                                       ...
                                                                       [TVkDescriptorImageInfo.Create(fInstance.Renderer.SSAOSampler.Handle,
                                                                                                      ...
                                                                                                      VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL), // TVkImageLayout(VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL))],
...
procedure TpvScene3DRendererPassesGlobalIlluminationCascadedVoxelConeTracingVisualVoxelizationRenderPass.ReleaseVolatileResources;
var Index:TpvSizeInt;
    PrimitiveTopology:TpvScene3D.TPrimitiveTopology;
    FaceCullingMode:TpvScene3D.TFaceCullingMode;
begin
...
procedure TpvScene3DRendererPassesGlobalIlluminationCascadedVoxelConeTracingVisualVoxelizationRenderPass.Update(const aUpdateInFlightFrameIndex,aUpdateFrameIndex:TpvSizeInt);
begin
 inherited Update(aUpdateInFlightFrameIndex,aUpdateFrameIndex);
end;

procedure TpvScene3DRendererPassesGlobalIlluminationCascadedVoxelConeTracingVisualVoxelizationRenderPass.OnSetRenderPassResources(const aCommandBuffer:TpvVulkanCommandBuffer;
                                                                             const aPipelineLayout:TpvVulkanPipelineLayout;
                                                                             const aRenderPassIndex:TpvSizeInt;
                                                                             const aPreviousInFlightFrameIndex:TpvSizeInt;
                                                                             const aInFlightFrameIndex:TpvSizeInt);
...
procedure TpvScene3DRendererPassesGlobalIlluminationCascadedVoxelConeTracingVisualVoxelizationRenderPass.Execute(const aCommandBuffer:TpvVulkanCommandBuffer;
