 ...
 *                                                                            *
 ******************************************************************************)
unit PasVulkan.Scene3D.Renderer.Passes.LensRainRenderPass;
{$i PasVulkan.inc}
{$ifndef fpc}
...
type { TpvScene3DRendererPassesLensRainRenderPass }
     TpvScene3DRendererPassesLensRainRenderPass=class(TpvFrameGraph.TRenderPass)
      public
      ...
      private
       ...
       fFactor:TpvScalar;
       fPushConstants:TpvScene3DRendererPassesLensRainRenderPass.TPushConstants;
      public
...
{ TpvScene3DRendererPassesLensRainRenderPass }

constructor TpvScene3DRendererPassesLensRainRenderPass.Create(const aFrameGraph:TpvFrameGraph;const aInstance:TpvScene3DRendererInstance);
begin
...
destructor TpvScene3DRendererPassesLensRainRenderPass.Destroy;
begin
 inherited Destroy;
end;

procedure TpvScene3DRendererPassesLensRainRenderPass.AcquirePersistentResources;
var Stream:TStream;
begin
 ...
 Stream:=pvScene3DShaderVirtualFileSystem.GetFile('lens_rain_frag.spv');
 try
...
procedure TpvScene3DRendererPassesLensRainRenderPass.ReleasePersistentResources;
begin
...
procedure TpvScene3DRendererPassesLensRainRenderPass.AcquireVolatileResources;
...
begin
 ...
 fVulkanDescriptorPool.AddDescriptorPoolSize(VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER,1*fInstance.Renderer.CountInFlightFrames);
 ...
 fVulkanPipelineLayout.AddPushConstantRange(TVkShaderStageFlags(VK_SHADER_STAGE_FRAGMENT_BIT),0,SizeOf(TpvScene3DRendererPassesLensRainRenderPass.TPushConstants));
...
procedure TpvScene3DRendererPassesLensRainRenderPass.ReleaseVolatileResources;
var InFlightFrameIndex:TpvSizeInt;
begin
...
procedure TpvScene3DRendererPassesLensRainRenderPass.Update(const aUpdateInFlightFrameIndex,aUpdateFrameIndex:TpvSizeInt);
begin
...
begin
 ...
 aCommandBuffer.CmdPushConstants(fVulkanPipelineLayout.Handle,
                                 ...
                                 0,
                                 SizeOf(TpvScene3DRendererPassesLensRainRenderPass.TPushConstants),
                                 @fPushConstants);
