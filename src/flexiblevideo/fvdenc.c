...
int main(int argc, char **argv) {
  ...
  if (argc < 2) {
    fprintf(stderr,
      ...
      "    --alpha-mv=<luma|              alpha motion: luma=share luma MVs (default); cpu-rd=per-frame own/shared by actual bytes; sad=own by MC-SAD heuristic; own=always own alpha MVs\n"
      "                cpu-rd|\n"
      "                sad|\n"
      "                own>\n"
