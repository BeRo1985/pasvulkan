 ...
 *                                                                            *
 ******************************************************************************)
unit PasVulkan.Scene3D.Renderer.Passes.DepthOfFieldPrefilterRenderPass;
{$i PasVulkan.inc}
{$ifndef fpc}
...
type { TpvScene3DRendererPassesDepthOfFieldPrefilterRenderPass }
     TpvScene3DRendererPassesDepthOfFieldPrefilterRenderPass=class(TpvFrameGraph.TRenderPass)
      public
...
constructor TpvScene3DRendererPassesDepthOfFieldPrefilterRenderPass.Create(const aFrameGraph:TpvFrameGraph;const aInstance:TpvScene3DRendererInstance);
begin
 ...
 Name:='DepthOfFieldPrefilterRenderPass';
...
//SeparateCommandBuffer:=true;
 ...
 fResourceOutput:=AddImageOutput('resourcetype_color_halfres',
                                 'resource_depthoffield_prefilter_halfres_data',
...
destructor TpvScene3DRendererPassesDepthOfFieldPrefilterRenderPass.Destroy;
begin
 inherited Destroy;
end;
...
begin
 ...
 Stream:=pvScene3DShaderVirtualFileSystem.GetFile('dof_prefilter_frag.spv');
 try
...
procedure TpvScene3DRendererPassesDepthOfFieldPrefilterRenderPass.ReleasePersistentResources;
begin
...
procedure TpvScene3DRendererPassesDepthOfFieldPrefilterRenderPass.AcquireVolatileResources;
...
begin
 ...
 fVulkanPipelineLayout.AddPushConstantRange(TVkShaderStageFlags(VK_SHADER_STAGE_FRAGMENT_BIT),0,SizeOf(TpvScene3DRendererPassesDepthOfFieldPrefilterRenderPass.TPushConstants));
...
procedure TpvScene3DRendererPassesDepthOfFieldPrefilterRenderPass.ReleaseVolatileResources;
var InFlightFrameIndex:TpvSizeInt;
begin
...
procedure TpvScene3DRendererPassesDepthOfFieldPrefilterRenderPass.Update(const aUpdateInFlightFrameIndex,aUpdateFrameIndex:TpvSizeInt);
begin
 inherited Update(aUpdateInFlightFrameIndex,aUpdateFrameIndex);
end;

procedure TpvScene3DRendererPassesDepthOfFieldPrefilterRenderPass.Execute(const aCommandBuffer:TpvVulkanCommandBuffer;const aInFlightFrameIndex,aFrameIndex:TpvSizeInt);
var //InFlightFrameState:TpvScene3DRendererInstance.PInFlightFrameState;
    PushConstants:TpvScene3DRendererPassesDepthOfFieldPrefilterRenderPass.TPushConstants;
begin
...
//InFlightFrameState:=@fInstance.InFlightFrameStates^[aInFlightFrameIndex];
 ...
 aCommandBuffer.CmdPushConstants(fVulkanPipelineLayout.Handle,
                                 ...
                                 0,
                                 SizeOf(TpvScene3DRendererPassesDepthOfFieldPrefilterRenderPass.TPushConstants),
                                 @PushConstants);
