 ...
 *                                                                            *
 ******************************************************************************)
unit PasVulkan.Scene3D.Renderer.Lens.Color;
{$i PasVulkan.inc}
{$ifndef fpc}
...
type { TpvScene3DRendererLensColor }
     TpvScene3DRendererLensColor=class
      public
       const Width=1024;
             Height=1;
...
{ TpvScene3DRendererLensColor }

constructor TpvScene3DRendererLensColor.Create(const aVulkanDevice:TpvVulkanDevice;const aVulkanPipelineCache:TpvVulkanPipelineCache;const aSampler:TpvVulkanSampler);
...
begin
 ...
 Stream:=pvScene3DShaderVirtualFileSystem.GetFile('lens_color_frag.spv');
 try
...
destructor TpvScene3DRendererLensColor.Destroy;
begin
