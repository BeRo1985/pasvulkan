 ...
 *                                                                            *
 ******************************************************************************)
unit PasVulkan.Scene3D.Renderer.Passes.CascadedShadowMapDepthResolveComputePass;
{$i PasVulkan.inc}
{$ifndef fpc}
...
type { TpvScene3DRendererPassesCascadedShadowMapDepthResolveComputePass }
     TpvScene3DRendererPassesCascadedShadowMapDepthResolveComputePass=class(TpvFrameGraph.TComputePass)
      public
...
{ TpvScene3DRendererPassesCascadedShadowMapDepthResolveComputePass  }

constructor TpvScene3DRendererPassesCascadedShadowMapDepthResolveComputePass.Create(const aFrameGraph:TpvFrameGraph;const aInstance:TpvScene3DRendererInstance);
begin
...
procedure TpvScene3DRendererPassesCascadedShadowMapDepthResolveComputePass.AcquirePersistentResources;
var Stream:TStream;
begin
...
procedure TpvScene3DRendererPassesCascadedShadowMapDepthResolveComputePass.ReleasePersistentResources;
begin
...
procedure TpvScene3DRendererPassesCascadedShadowMapDepthResolveComputePass.AcquireVolatileResources;
...
begin
 ...
 fPipelineLayout.AddPushConstantRange(TVkShaderStageFlags(VK_SHADER_STAGE_COMPUTE_BIT),0,SizeOf(TpvScene3DRendererPassesCascadedShadowMapDepthResolveComputePass.TPushConstants));
...
procedure TpvScene3DRendererPassesCascadedShadowMapDepthResolveComputePass.ReleaseVolatileResources;
var InFlightFrameIndex,MipMapLevelIndex:TpvInt32;
begin
...
procedure TpvScene3DRendererPassesCascadedShadowMapDepthResolveComputePass.Update(const aUpdateInFlightFrameIndex,aUpdateFrameIndex:TpvSizeInt);
begin
 inherited Update(aUpdateInFlightFrameIndex,aUpdateFrameIndex);
end;

procedure TpvScene3DRendererPassesCascadedShadowMapDepthResolveComputePass.Execute(const aCommandBuffer:TpvVulkanCommandBuffer;const aInFlightFrameIndex,aFrameIndex:TpvSizeInt);
var InFlightFrameIndex:TpvInt32;
    ImageMemoryBarrier:TVkImageMemoryBarrier;
    PushConstants:TpvScene3DRendererPassesCascadedShadowMapDepthResolveComputePass.TPushConstants;
begin
 ...
 begin
  ...
  aCommandBuffer.CmdPushConstants(fPipelineLayout.Handle,
                                  ...
                                  0,
                                  SizeOf(TpvScene3DRendererPassesCascadedShadowMapDepthResolveComputePass.TPushConstants),
                                  @PushConstants);
