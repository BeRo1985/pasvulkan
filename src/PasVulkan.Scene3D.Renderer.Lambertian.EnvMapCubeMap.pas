 ...
 *                                                                            *
 ******************************************************************************)
unit PasVulkan.Scene3D.Renderer.Lambertian.EnvMapCubeMap;
{$i PasVulkan.inc}
{$ifndef fpc}
...
type { TpvScene3DRendererLambertianEnvMapCubeMap }
     TpvScene3DRendererLambertianEnvMapCubeMap=class
      public
       const Width=256;
             Height=256;
             Samples=2048;
...
{ TpvScene3DRendererLambertianEnvMapCubeMap }

constructor TpvScene3DRendererLambertianEnvMapCubeMap.Create(const aVulkanDevice:TpvVulkanDevice;const aVulkanPipelineCache:TpvVulkanPipelineCache;const aDescriptorImageInfo:TVkDescriptorImageInfo;const aImageFormat:TVkFormat=TVkFormat(VK_FORMAT_R16G16B16A16_SFLOAT));
...
begin
 ...
 Stream:=pvScene3DShaderVirtualFileSystem.GetFile('cubemap_lambertian_filter_comp.spv');
 try
...
destructor TpvScene3DRendererLambertianEnvMapCubeMap.Destroy;
begin
