 ...
 *                                                                            *
 ******************************************************************************)
unit PasVulkan.Scene3D.Renderer.Passes.DepthOfFieldPostBlurRenderPass;
{$i PasVulkan.inc}
{$ifndef fpc}
...
type { TpvScene3DRendererPassesDepthOfFieldPostBlurRenderPass }
     TpvScene3DRendererPassesDepthOfFieldPostBlurRenderPass=class(TpvFrameGraph.TRenderPass)
      private
...
constructor TpvScene3DRendererPassesDepthOfFieldPostBlurRenderPass.Create(const aFrameGraph:TpvFrameGraph;const aInstance:TpvScene3DRendererInstance);
begin
 ...
 Name:='DepthOfFieldPostBlurRenderPass';
...
//SeparateCommandBuffer:=true;
 ...
 fResourceColor:=AddImageInput('resourcetype_color_halfres',
                               'resource_depthoffield_blur_halfres_data',
...
destructor TpvScene3DRendererPassesDepthOfFieldPostBlurRenderPass.Destroy;
begin
 inherited Destroy;
end;

procedure TpvScene3DRendererPassesDepthOfFieldPostBlurRenderPass.AcquirePersistentResources;
var Stream:TStream;
begin
 ...
 Stream:=pvScene3DShaderVirtualFileSystem.GetFile('dof_postblur_frag.spv');
 try
...
procedure TpvScene3DRendererPassesDepthOfFieldPostBlurRenderPass.ReleasePersistentResources;
begin
...
procedure TpvScene3DRendererPassesDepthOfFieldPostBlurRenderPass.AcquireVolatileResources;
...
procedure TpvScene3DRendererPassesDepthOfFieldPostBlurRenderPass.ReleaseVolatileResources;
var InFlightFrameIndex:TpvSizeInt;
begin
...
procedure TpvScene3DRendererPassesDepthOfFieldPostBlurRenderPass.Update(const aUpdateInFlightFrameIndex,aUpdateFrameIndex:TpvSizeInt);
begin
 inherited Update(aUpdateInFlightFrameIndex,aUpdateFrameIndex);
end;

procedure TpvScene3DRendererPassesDepthOfFieldPostBlurRenderPass.Execute(const aCommandBuffer:TpvVulkanCommandBuffer;const aInFlightFrameIndex,aFrameIndex:TpvSizeInt);
begin
