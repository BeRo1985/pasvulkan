 ...
 *                                                                            *
 ******************************************************************************)
unit PasVulkan.Scene3D.Renderer.Passes.TopDownSkyOcclusionMapResolveRenderPass;
{$i PasVulkan.inc}
{$ifndef fpc}
...
type { TpvScene3DRendererPassesTopDownSkyOcclusionMapResolveRenderPass }
...
{ TpvScene3DRendererPassesTopDownSkyOcclusionMapResolveRenderPass }

constructor TpvScene3DRendererPassesTopDownSkyOcclusionMapResolveRenderPass.Create(const aFrameGraph:TpvFrameGraph;const aInstance:TpvScene3DRendererInstance);
...
begin
 ...
 Name:='TopDownSkyOcclusionMapResolveRenderPass';
...
destructor TpvScene3DRendererPassesTopDownSkyOcclusionMapResolveRenderPass.Destroy;
begin
 inherited Destroy;
end;

procedure TpvScene3DRendererPassesTopDownSkyOcclusionMapResolveRenderPass.AcquirePersistentResources;
var Stream:TStream;
begin
 ...
 Stream:=pvScene3DShaderVirtualFileSystem.GetFile('topdownskyocclusionmap_resolve_frag.spv');
 try
...
procedure TpvScene3DRendererPassesTopDownSkyOcclusionMapResolveRenderPass.ReleasePersistentResources;
begin
...
procedure TpvScene3DRendererPassesTopDownSkyOcclusionMapResolveRenderPass.AcquireVolatileResources;
...
begin
 ...
 fVulkanPipelineLayout.AddPushConstantRange(TVkShaderStageFlags(VK_SHADER_STAGE_FRAGMENT_BIT),0,SizeOf(TpvScene3DRendererPassesTopDownSkyOcclusionMapResolveRenderPass.TFragmentStagePushConstants));
 ...
 fVulkanGraphicsPipeline.ViewPortState.AddViewPort(0.0,0.0,fInstance.TopDownSkyOcclusionMapWidth,fInstance.TopDownSkyOcclusionMapHeight,0.0,1.0);
 fVulkanGraphicsPipeline.ViewPortState.AddScissor(0,0,fInstance.TopDownSkyOcclusionMapWidth,fInstance.TopDownSkyOcclusionMapHeight);
...
procedure TpvScene3DRendererPassesTopDownSkyOcclusionMapResolveRenderPass.ReleaseVolatileResources;
var InFlightFrameIndex:TpvSizeInt;
begin
...
procedure TpvScene3DRendererPassesTopDownSkyOcclusionMapResolveRenderPass.Update(const aUpdateInFlightFrameIndex,aUpdateFrameIndex:TpvSizeInt);
begin
...
begin
 ...
 fFragmentStagePushConstants.InverseViewProjectionMatrix:=InFlightFrameState^.TopDownSkyOcclusionMapViewProjectionMatrix.Inverse;
 ...
 aCommandBuffer.CmdPushConstants(fVulkanPipelineLayout.Handle,
                                 ...
                                 0,
                                 SizeOf(TpvScene3DRendererPassesTopDownSkyOcclusionMapResolveRenderPass.TFragmentStagePushConstants),
