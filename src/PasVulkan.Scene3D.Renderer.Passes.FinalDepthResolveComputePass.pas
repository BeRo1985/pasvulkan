 ...
 *                                                                            *
 ******************************************************************************)
unit PasVulkan.Scene3D.Renderer.Passes.FinalDepthResolveComputePass;
{$i PasVulkan.inc}
{$ifndef fpc}
...
type { TpvScene3DRendererPassesFinalDepthResolveComputePass }
     TpvScene3DRendererPassesFinalDepthResolveComputePass=class(TpvFrameGraph.TComputePass)
      public
...
{ TpvScene3DRendererPassesFinalDepthResolveComputePass  }

constructor TpvScene3DRendererPassesFinalDepthResolveComputePass.Create(const aFrameGraph:TpvFrameGraph;const aInstance:TpvScene3DRendererInstance;const aCullRenderPass:TpvScene3DRendererCullRenderPass);
begin
 ...
 case fCullRenderPass of
  TpvScene3DRendererCullRenderPass.FinalView:begin
   Name:='FinalViewFinalDepthResolveComputePass';
  end;
  TpvScene3DRendererCullRenderPass.CascadedShadowMap:begin
   Name:='CascadedShadowMapFinalDepthResolveComputePass';
  end;
  else begin
   Name:='FinalDepthResolveComputePass';
  end;
 end;
...
destructor TpvScene3DRendererPassesFinalDepthResolveComputePass.Destroy;
begin
 inherited Destroy;
end;

procedure TpvScene3DRendererPassesFinalDepthResolveComputePass.AcquirePersistentResources;
var Stream:TStream;
begin
   ...
   if fInstance.Renderer.SurfaceSampleCountFlagBits=TVkSampleCountFlagBits(VK_SAMPLE_COUNT_1_BIT) then begin
    if fInstance.ZFar<0.0 then begin
     if fInstance.CountSurfaceViews>1 then begin
      Stream:=pvScene3DShaderVirtualFileSystem.GetFile('final_depth_resolve_multiview_reversedz_comp.spv');
     end else begin
      Stream:=pvScene3DShaderVirtualFileSystem.GetFile('final_depth_resolve_reversedz_comp.spv');
     end;
    end else begin
     if fInstance.CountSurfaceViews>1 then begin
      Stream:=pvScene3DShaderVirtualFileSystem.GetFile('final_depth_resolve_multiview_comp.spv');
     end else begin
      Stream:=pvScene3DShaderVirtualFileSystem.GetFile('final_depth_resolve_comp.spv');
     end;
    end;
   end else begin
    if fInstance.ZFar<0.0 then begin
     if fInstance.CountSurfaceViews>1 then begin
      Stream:=pvScene3DShaderVirtualFileSystem.GetFile('final_depth_resolve_multiview_msaa_reversedz_comp.spv');
     end else begin
      Stream:=pvScene3DShaderVirtualFileSystem.GetFile('final_depth_resolve_msaa_reversedz_comp.spv');
     end;
    end else begin
     if fInstance.CountSurfaceViews>1 then begin
      Stream:=pvScene3DShaderVirtualFileSystem.GetFile('final_depth_resolve_multiview_msaa_comp.spv');
     end else begin
      Stream:=pvScene3DShaderVirtualFileSystem.GetFile('final_depth_resolve_msaa_comp.spv');
     end;
    end;
   end;
...
procedure TpvScene3DRendererPassesFinalDepthResolveComputePass.ReleasePersistentResources;
begin
...
procedure TpvScene3DRendererPassesFinalDepthResolveComputePass.AcquireVolatileResources;
...
begin
 ...
 case fCullRenderPass of
  TpvScene3DRendererCullRenderPass.CascadedShadowMap:begin
   ...
   Array2DImage:=fInstance.FinalDepthArray2DImage;
 ...
 fPipelineLayout.AddPushConstantRange(TVkShaderStageFlags(VK_SHADER_STAGE_COMPUTE_BIT),0,SizeOf(TpvScene3DRendererPassesFinalDepthResolveComputePass.TPushConstants));
...
procedure TpvScene3DRendererPassesFinalDepthResolveComputePass.ReleaseVolatileResources;
...
procedure TpvScene3DRendererPassesFinalDepthResolveComputePass.Update(const aUpdateInFlightFrameIndex,aUpdateFrameIndex:TpvSizeInt);
begin
 inherited Update(aUpdateInFlightFrameIndex,aUpdateFrameIndex);
end;

procedure TpvScene3DRendererPassesFinalDepthResolveComputePass.Execute(const aCommandBuffer:TpvVulkanCommandBuffer;const aInFlightFrameIndex,aFrameIndex:TpvSizeInt);
var InFlightFrameIndex,CountViews:TpvInt32;
    ImageMemoryBarrier:TVkImageMemoryBarrier;
    PushConstants:TpvScene3DRendererPassesFinalDepthResolveComputePass.TPushConstants;
    Array2DImage:TpvScene3DRendererArray2DImage;
begin
 ...
 begin
  ...
  aCommandBuffer.CmdPushConstants(fPipelineLayout.Handle,
                                  ...
                                  0,
                                  SizeOf(TpvScene3DRendererPassesFinalDepthResolveComputePass.TPushConstants),
                                  @PushConstants);
  ...
  if assigned(fInstance.Renderer.VulkanDevice.BreadcrumbBuffer) then begin
   fInstance.Renderer.VulkanDevice.BreadcrumbBuffer.BeginBreadcrumb(aCommandBuffer.Handle,TpvVulkanBreadcrumbType.Dispatch,'CullDepthResolve');
  end;
