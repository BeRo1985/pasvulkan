 ...
 *                                                                            *
 ******************************************************************************)
unit PasVulkan.Scene3D.Renderer.Passes.CascadedShadowMapDepthPyramidComputePass;
{$i PasVulkan.inc}
{$ifndef fpc}
...
type { TpvScene3DRendererPassesCascadedShadowMapDepthPyramidComputePass }
     TpvScene3DRendererPassesCascadedShadowMapDepthPyramidComputePass=class(TpvFrameGraph.TComputePass)
      private
...
{ TpvScene3DRendererPassesCascadedShadowMapDepthPyramidComputePass  }

constructor TpvScene3DRendererPassesCascadedShadowMapDepthPyramidComputePass.Create(const aFrameGraph:TpvFrameGraph;const aInstance:TpvScene3DRendererInstance);
begin
...
destructor TpvScene3DRendererPassesCascadedShadowMapDepthPyramidComputePass.Destroy;
begin
 inherited Destroy;
end;

procedure TpvScene3DRendererPassesCascadedShadowMapDepthPyramidComputePass.AcquirePersistentResources;
var Stream:TStream;
begin
...
procedure TpvScene3DRendererPassesCascadedShadowMapDepthPyramidComputePass.ReleasePersistentResources;
begin
...
procedure TpvScene3DRendererPassesCascadedShadowMapDepthPyramidComputePass.AcquireVolatileResources;
...
procedure TpvScene3DRendererPassesCascadedShadowMapDepthPyramidComputePass.ReleaseVolatileResources;
var InFlightFrameIndex,MipMapLevelSetIndex:TpvInt32;
begin
...
procedure TpvScene3DRendererPassesCascadedShadowMapDepthPyramidComputePass.Update(const aUpdateInFlightFrameIndex,aUpdateFrameIndex:TpvSizeInt);
begin
 inherited Update(aUpdateInFlightFrameIndex,aUpdateFrameIndex);
end;

procedure TpvScene3DRendererPassesCascadedShadowMapDepthPyramidComputePass.Execute(const aCommandBuffer:TpvVulkanCommandBuffer;const aInFlightFrameIndex,aFrameIndex:TpvSizeInt);
