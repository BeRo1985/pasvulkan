 ...
 *                                                                            *
 ******************************************************************************)
unit PasVulkan.Scene3D.Renderer.Passes.CascadedShadowMapCullDepthPyramidComputePass;
{$i PasVulkan.inc}
{$ifndef fpc}
...
type { TpvScene3DRendererPassesCascadedShadowMapCullDepthPyramidComputePass }
     TpvScene3DRendererPassesCascadedShadowMapCullDepthPyramidComputePass=class(TpvFrameGraph.TComputePass)
      private
...
{ TpvScene3DRendererPassesCascadedShadowMapCullDepthPyramidComputePass  }

constructor TpvScene3DRendererPassesCascadedShadowMapCullDepthPyramidComputePass.Create(const aFrameGraph:TpvFrameGraph;const aInstance:TpvScene3DRendererInstance);
begin
 inherited Create(aFrameGraph);

 fInstance:=aInstance;

 Name:='CascadedShadowMapDepthPyramidComputePass';
...
destructor TpvScene3DRendererPassesCascadedShadowMapCullDepthPyramidComputePass.Destroy;
begin
 inherited Destroy;
end;

procedure TpvScene3DRendererPassesCascadedShadowMapCullDepthPyramidComputePass.AcquirePersistentResources;
var Stream:TStream;
begin
 ...
 fInstance.Renderer.VulkanDevice.DebugUtils.SetObjectName(fFirstPassComputeShaderModule.Handle,VK_OBJECT_TYPE_SHADER_MODULE,'CascadedShadowMapDepthPyramidComputePass.fFirstPassComputeShaderModule');
 ...
 fInstance.Renderer.VulkanDevice.DebugUtils.SetObjectName(fReductionComputeShaderModule.Handle,VK_OBJECT_TYPE_SHADER_MODULE,'CascadedShadowMapDepthPyramidComputePass.fReductionComputeShaderModule');
...
procedure TpvScene3DRendererPassesCascadedShadowMapCullDepthPyramidComputePass.ReleasePersistentResources;
begin
...
procedure TpvScene3DRendererPassesCascadedShadowMapCullDepthPyramidComputePass.AcquireVolatileResources;
...
begin
 ...
 fInstance.Renderer.VulkanDevice.DebugUtils.SetObjectName(fFirstPassVulkanDescriptorPool.Handle,VK_OBJECT_TYPE_DESCRIPTOR_POOL,'CascadedShadowMapDepthPyramidComputePass.fFirstPassVulkanDescriptorPool');
 ...
 fInstance.Renderer.VulkanDevice.DebugUtils.SetObjectName(fFirstPassVulkanDescriptorSetLayout.Handle,VK_OBJECT_TYPE_DESCRIPTOR_SET_LAYOUT,'CascadedShadowMapDepthPyramidComputePass.fFirstPassVulkanDescriptorSetLayout');
 ...
 fInstance.Renderer.VulkanDevice.DebugUtils.SetObjectName(fFirstPassPipelineLayout.Handle,VK_OBJECT_TYPE_PIPELINE_LAYOUT,'CascadedShadowMapDepthPyramidComputePass.fFirstPassPipelineLayout');
 ...
 fFirstPassPipeline:=TpvVulkanComputePipeline.Create(fInstance.Renderer.VulkanDevice,
                                                     ...
                                                     nil,
                                                     0);
 fInstance.Renderer.VulkanDevice.DebugUtils.SetObjectName(fFirstPassPipeline.Handle,VK_OBJECT_TYPE_PIPELINE,'CascadedShadowMapDepthPyramidComputePass.fFirstPassPipeline');
 ...
 for InFlightFrameIndex:=0 to FrameGraph.CountInFlightFrames-1 do begin
  ...
  fInstance.Renderer.VulkanDevice.DebugUtils.SetObjectName(fVulkanImageViews[InFlightFrameIndex].Handle,VK_OBJECT_TYPE_IMAGE_VIEW,'CascadedShadowMapDepthPyramidComputePass.fVulkanImageViews['+IntToStr(InFlightFrameIndex)+']');
  ...
  fFirstPassVulkanDescriptorSets[InFlightFrameIndex].WriteToDescriptorSet(1,
                                                                          ...
                                                                          [TVkDescriptorImageInfo.Create(fInstance.Renderer.ClampedNearestSampler.Handle,
                                                                                                         fInstance.CascadedShadowMapCullDepthPyramidMipmappedArray2DImage.VulkanImageViews[0].Handle,
  ...
  fInstance.Renderer.VulkanDevice.DebugUtils.SetObjectName(fFirstPassVulkanDescriptorSets[InFlightFrameIndex].Handle,VK_OBJECT_TYPE_DESCRIPTOR_SET,'CascadedShadowMapDepthPyramidComputePass.fFirstPassVulkanDescriptorSets['+IntToStr(InFlightFrameIndex)+']');
 end;
 ...
 fInstance.Renderer.VulkanDevice.DebugUtils.SetObjectName(fReductionVulkanDescriptorPool.Handle,VK_OBJECT_TYPE_DESCRIPTOR_POOL,'CascadedShadowMapDepthPyramidComputePass.fReductionVulkanDescriptorPool');
 ...
 fInstance.Renderer.VulkanDevice.DebugUtils.SetObjectName(fReductionVulkanDescriptorSetLayout.Handle,VK_OBJECT_TYPE_DESCRIPTOR_SET_LAYOUT,'CascadedShadowMapDepthPyramidComputePass.fReductionVulkanDescriptorSetLayout');
 ...
 fInstance.Renderer.VulkanDevice.DebugUtils.SetObjectName(fReductionPipelineLayout.Handle,VK_OBJECT_TYPE_PIPELINE_LAYOUT,'CascadedShadowMapDepthPyramidComputePass.fReductionPipelineLayout');
 ...
 fReductionPipeline:=TpvVulkanComputePipeline.Create(fInstance.Renderer.VulkanDevice,
                                                     ...
                                                     nil,
                                                     0);
 fInstance.Renderer.VulkanDevice.DebugUtils.SetObjectName(fReductionPipeline.Handle,VK_OBJECT_TYPE_PIPELINE,'CascadedShadowMapDepthPyramidComputePass.fReductionPipeline');

 fCountMipMapLevelSets:=Min(((fInstance.CascadedShadowMapCullDepthPyramidMipmappedArray2DImage.MipMapLevels-1)+3) shr 2,8);
 ...
 for InFlightFrameIndex:=0 to FrameGraph.CountInFlightFrames-1 do begin
  for MipMapLevelSetIndex:=0 to fCountMipMapLevelSets-1 do begin
   ...
   fReductionVulkanDescriptorSets[InFlightFrameIndex,MipMapLevelSetIndex].WriteToDescriptorSet(0,
                                                                                               ...
                                                                                               TVkDescriptorType(VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER),
                                                                                               [TVkDescriptorImageInfo.Create(Sampler.Handle,
                                                                                                                              fInstance.CascadedShadowMapCullDepthPyramidMipmappedArray2DImage.VulkanImageViews[Min(MipMapLevelSetIndex shl 2,fInstance.CascadedShadowMapCullDepthPyramidMipmappedArray2DImage.MipMapLevels-1)].Handle,
                                                                                                                              VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL)],
                                                                                               [],
                                                                                               [],
                                                                                               false
   ...
   fReductionVulkanDescriptorSets[InFlightFrameIndex,MipMapLevelSetIndex].WriteToDescriptorSet(1,
                                                                                               ...
                                                                                               TVkDescriptorType(VK_DESCRIPTOR_TYPE_STORAGE_IMAGE),
                                                                                               [TVkDescriptorImageInfo.Create(fInstance.Renderer.ClampedNearestSampler.Handle,
                                                                                                                              fInstance.CascadedShadowMapCullDepthPyramidMipmappedArray2DImage.VulkanImageViews[Min(((MipMapLevelSetIndex shl 2)+1),fInstance.CascadedShadowMapCullDepthPyramidMipmappedArray2DImage.MipMapLevels-1)].Handle,
                                                                                                                              VK_IMAGE_LAYOUT_GENERAL),
                                                                                                TVkDescriptorImageInfo.Create(fInstance.Renderer.ClampedNearestSampler.Handle,
                                                                                                                              fInstance.CascadedShadowMapCullDepthPyramidMipmappedArray2DImage.VulkanImageViews[Min(((MipMapLevelSetIndex shl 2)+2),fInstance.CascadedShadowMapCullDepthPyramidMipmappedArray2DImage.MipMapLevels-1)].Handle,
                                                                                                                              VK_IMAGE_LAYOUT_GENERAL),
                                                                                                TVkDescriptorImageInfo.Create(fInstance.Renderer.ClampedNearestSampler.Handle,
                                                                                                                              fInstance.CascadedShadowMapCullDepthPyramidMipmappedArray2DImage.VulkanImageViews[Min(((MipMapLevelSetIndex shl 2)+3),fInstance.CascadedShadowMapCullDepthPyramidMipmappedArray2DImage.MipMapLevels-1)].Handle,
                                                                                                                              VK_IMAGE_LAYOUT_GENERAL),
                                                                                                TVkDescriptorImageInfo.Create(fInstance.Renderer.ClampedNearestSampler.Handle,
                                                                                                                              fInstance.CascadedShadowMapCullDepthPyramidMipmappedArray2DImage.VulkanImageViews[Min(((MipMapLevelSetIndex shl 2)+4),fInstance.CascadedShadowMapCullDepthPyramidMipmappedArray2DImage.MipMapLevels-1)].Handle,
                                                                                                                              VK_IMAGE_LAYOUT_GENERAL)],
                                                                                               [],
                                                                                               [],
                                                                                               false
   ...
   fInstance.Renderer.VulkanDevice.DebugUtils.SetObjectName(fReductionVulkanDescriptorSets[InFlightFrameIndex,MipMapLevelSetIndex].Handle,VK_OBJECT_TYPE_DESCRIPTOR_SET,'CascadedShadowMapDepthPyramidComputePass.fReductionVulkanDescriptorSets['+IntToStr(InFlightFrameIndex)+','+IntToStr(MipMapLevelSetIndex)+']');
  end;
 end;

end;

procedure TpvScene3DRendererPassesCascadedShadowMapCullDepthPyramidComputePass.ReleaseVolatileResources;
var InFlightFrameIndex,MipMapLevelSetIndex:TpvInt32;
begin
...
procedure TpvScene3DRendererPassesCascadedShadowMapCullDepthPyramidComputePass.Update(const aUpdateInFlightFrameIndex,aUpdateFrameIndex:TpvSizeInt);
begin
 inherited Update(aUpdateInFlightFrameIndex,aUpdateFrameIndex);
end;

procedure TpvScene3DRendererPassesCascadedShadowMapCullDepthPyramidComputePass.Execute(const aCommandBuffer:TpvVulkanCommandBuffer;const aInFlightFrameIndex,aFrameIndex:TpvSizeInt);
...
begin
 ...
 begin
  ...
  ImageMemoryBarrier.image:=fInstance.CascadedShadowMapCullDepthPyramidMipmappedArray2DImage.VulkanImage.Handle;
  ImageMemoryBarrier.subresourceRange.aspectMask:=TVkImageAspectFlags(VK_IMAGE_ASPECT_COLOR_BIT);
  ImageMemoryBarrier.subresourceRange.baseMipLevel:=0;
  ImageMemoryBarrier.subresourceRange.levelCount:=fInstance.CascadedShadowMapCullDepthPyramidMipmappedArray2DImage.MipMapLevels;
  ImageMemoryBarrier.subresourceRange.baseArrayLayer:=0;
  ImageMemoryBarrier.subresourceRange.layerCount:=TpvScene3DRendererInstance.CountCascadedShadowMapCascades;
 ...
 begin
  ...
  aCommandBuffer.CmdDispatch(Max(1,(fInstance.CascadedShadowMapCullDepthPyramidMipmappedArray2DImage.Width+((1 shl 4)-1)) shr 4),
                             Max(1,(fInstance.CascadedShadowMapCullDepthPyramidMipmappedArray2DImage.Height+((1 shl 4)-1)) shr 4),
                             TpvScene3DRendererInstance.CountCascadedShadowMapCascades);
 ...
 begin
  ...
  for MipMapLevelSetIndex:=0 to fCountMipMapLevelSets-1 do begin
   ...
   CountMipMaps:=Min(4,fInstance.CascadedShadowMapCullDepthPyramidMipmappedArray2DImage.MipMapLevels-MipMapLevelIndex);
   ...
   aCommandBuffer.CmdDispatch(Max(1,(fInstance.CascadedShadowMapCullDepthPyramidMipmappedArray2DImage.Width+((1 shl (3+MipMapLevelIndex))-1)) shr (3+MipMapLevelIndex)),
                              Max(1,(fInstance.CascadedShadowMapCullDepthPyramidMipmappedArray2DImage.Height+((1 shl (3+MipMapLevelIndex))-1)) shr (3+MipMapLevelIndex)),
                              TpvScene3DRendererInstance.CountCascadedShadowMapCascades);
