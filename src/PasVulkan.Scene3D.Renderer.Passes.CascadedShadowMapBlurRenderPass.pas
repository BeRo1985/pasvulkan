 ...
 *                                                                            *
 ******************************************************************************)
unit PasVulkan.Scene3D.Renderer.Passes.CascadedShadowMapBlurRenderPass;
{$i PasVulkan.inc}
{$ifndef fpc}
...
type { TpvScene3DRendererPassesCascadedShadowMapBlurRenderPass }
     TpvScene3DRendererPassesCascadedShadowMapBlurRenderPass=class(TpvFrameGraph.TRenderPass)
      private
...
{ TpvScene3DRendererPassesCascadedShadowMapBlurRenderPass }

constructor TpvScene3DRendererPassesCascadedShadowMapBlurRenderPass.Create(const aFrameGraph:TpvFrameGraph;const aInstance:TpvScene3DRendererInstance;const aHorziontal:boolean);
...
destructor TpvScene3DRendererPassesCascadedShadowMapBlurRenderPass.Destroy;
begin
 inherited Destroy;
end;

procedure TpvScene3DRendererPassesCascadedShadowMapBlurRenderPass.Show;
var Stream:TStream;
begin
 ...
 Stream:=pvScene3DShaderVirtualFileSystem.GetFile('msm_blur_vert.spv');
 try
 ...
 Stream:=pvScene3DShaderVirtualFileSystem.GetFile('msm_blur_frag.spv');
 try
...
procedure TpvScene3DRendererPassesCascadedShadowMapBlurRenderPass.Hide;
begin
...
procedure TpvScene3DRendererPassesCascadedShadowMapBlurRenderPass.AfterCreateSwapChain;
...
begin
 ...
 fVulkanPipelineLayout.AddPushConstantRange(TVkShaderStageFlags(VK_SHADER_STAGE_FRAGMENT_BIT),0,SizeOf(TpvScene3DRendererPassesCascadedShadowMapBlurRenderPass.TFragmentStagePushConstants));
...
procedure TpvScene3DRendererPassesCascadedShadowMapBlurRenderPass.BeforeDestroySwapChain;
var InFlightFrameIndex:TpvSizeInt;
begin
...
procedure TpvScene3DRendererPassesCascadedShadowMapBlurRenderPass.Execute(const aCommandBuffer:TpvVulkanCommandBuffer;const aInFlightFrameIndex,aFrameIndex:TpvSizeInt);
begin
 ...
 aCommandBuffer.CmdPushConstants(fVulkanPipelineLayout.Handle,
                                 ...
                                 0,
                                 SizeOf(TpvScene3DRendererPassesCascadedShadowMapBlurRenderPass.TFragmentStagePushConstants),
