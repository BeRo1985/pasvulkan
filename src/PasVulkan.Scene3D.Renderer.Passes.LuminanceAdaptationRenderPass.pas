 ...
 *                                                                            *
 ******************************************************************************)
unit PasVulkan.Scene3D.Renderer.Passes.LuminanceAdaptationRenderPass;
{$i PasVulkan.inc}
{$ifndef fpc}
...
{ TpvScene3DRendererPassesLuminanceAdaptationRenderPass }

constructor TpvScene3DRendererPassesLuminanceAdaptationRenderPass.Create(const aFrameGraph:TpvFrameGraph;const aInstance:TpvScene3DRendererInstance);
begin
 ...
 Name:='LuminanceAdaptationRenderPass';
...
{if fInstance.Renderer.AntialiasingMode=TpvScene3DRendererAntialiasingMode.TAA then begin
 ...
 fResourceSurface:=AddImageOutput('resourcetype_color_optimized_non_alpha',
                                  'resource_luminance_adapted_color',
...
destructor TpvScene3DRendererPassesLuminanceAdaptationRenderPass.Destroy;
begin
 inherited Destroy;
end;

procedure TpvScene3DRendererPassesLuminanceAdaptationRenderPass.AcquirePersistentResources;
var Stream:TStream;
begin
 ...
 Stream:=pvScene3DShaderVirtualFileSystem.GetFile('luminance_adaptation_frag.spv');
 try
...
procedure TpvScene3DRendererPassesLuminanceAdaptationRenderPass.ReleasePersistentResources;
begin
...
procedure TpvScene3DRendererPassesLuminanceAdaptationRenderPass.AcquireVolatileResources;
...
procedure TpvScene3DRendererPassesLuminanceAdaptationRenderPass.ReleaseVolatileResources;
var InFlightFrameIndex:TpvSizeInt;
begin
...
procedure TpvScene3DRendererPassesLuminanceAdaptationRenderPass.Update(const aUpdateInFlightFrameIndex,aUpdateFrameIndex:TpvSizeInt);
begin
...
begin
 ...
 if assigned(fInstance.Renderer.VulkanDevice.BreadcrumbBuffer) then begin
  fInstance.Renderer.VulkanDevice.BreadcrumbBuffer.BeginBreadcrumb(aCommandBuffer.Handle,TpvVulkanBreadcrumbType.Draw,'LuminanceAdaptation');
 end;
