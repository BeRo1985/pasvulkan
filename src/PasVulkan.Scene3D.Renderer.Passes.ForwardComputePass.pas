 ...
 *                                                                            *
 ******************************************************************************)
unit PasVulkan.Scene3D.Renderer.Passes.ForwardComputePass;
{$i PasVulkan.inc}
{$ifndef fpc}
...
{ TpvScene3DRendererPassesForwardComputePass }

constructor TpvScene3DRendererPassesForwardComputePass.Create(const aFrameGraph:TpvFrameGraph;const aInstance:TpvScene3DRendererInstance);
begin
...
destructor TpvScene3DRendererPassesForwardComputePass.Destroy;
begin
 inherited Destroy;
end;

procedure TpvScene3DRendererPassesForwardComputePass.AcquirePersistentResources;
var Stream:TStream;
begin

 inherited AcquirePersistentResources;

 Stream:=pvScene3DShaderVirtualFileSystem.GetFile('space_lines_comp.spv');
 try
...
procedure TpvScene3DRendererPassesForwardComputePass.AcquireVolatileResources;
...
procedure TpvScene3DRendererPassesForwardComputePass.Update(const aUpdateInFlightFrameIndex,aUpdateFrameIndex:TpvSizeInt);
begin
 inherited Update(aUpdateInFlightFrameIndex,aUpdateFrameIndex);
end;

procedure TpvScene3DRendererPassesForwardComputePass.Execute(const aCommandBuffer:TpvVulkanCommandBuffer;const aInFlightFrameIndex,aFrameIndex:TpvSizeInt);
var InFlightFrameIndex:TpvInt32;
...
begin
 ...
 if fInstance.SpaceLinesPrimitiveDynamicArrays[aInFlightFrameIndex].Count>0 then begin
  ...
  PushConstants.CountPrimitives:=fInstance.SpaceLinesPrimitiveDynamicArrays[aInFlightFrameIndex].Count;
