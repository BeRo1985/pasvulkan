 ...
 *                                                                            *
 ******************************************************************************)
unit PasVulkan.Scene3D.Renderer.Passes.BloomDownsampleComputePass;
{$i PasVulkan.inc}
{$ifndef fpc}
...
type { TpvScene3DRendererPassesBloomDownsampleComputePass }
     TpvScene3DRendererPassesBloomDownsampleComputePass=class(TpvFrameGraph.TComputePass)
      private
...
{ TpvScene3DRendererPassesBloomDownsampleComputePass }

constructor TpvScene3DRendererPassesBloomDownsampleComputePass.Create(const aFrameGraph:TpvFrameGraph;const aInstance:TpvScene3DRendererInstance);
begin
 inherited Create(aFrameGraph);

 fInstance:=aInstance;

 Name:='BloomDownsampleComputePass';
...
destructor TpvScene3DRendererPassesBloomDownsampleComputePass.Destroy;
begin
 inherited Destroy;
end;

procedure TpvScene3DRendererPassesBloomDownsampleComputePass.AcquirePersistentResources;
var Stream:TStream;
    Format:string;
begin
...
procedure TpvScene3DRendererPassesBloomDownsampleComputePass.ReleasePersistentResources;
begin
...
procedure TpvScene3DRendererPassesBloomDownsampleComputePass.AcquireVolatileResources;
...
begin
 ...
 fVulkanDescriptorPool:=TpvVulkanDescriptorPool.Create(fInstance.Renderer.VulkanDevice,
                                                       ...
                                                       fInstance.Renderer.CountInFlightFrames*fInstance.BloomMipmappedArray2DImages[0].MipMapLevels);
 fVulkanDescriptorPool.AddDescriptorPoolSize(VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER,fInstance.Renderer.CountInFlightFrames*fInstance.BloomMipmappedArray2DImages[0].MipMapLevels);
 fVulkanDescriptorPool.AddDescriptorPoolSize(VK_DESCRIPTOR_TYPE_STORAGE_IMAGE,fInstance.Renderer.CountInFlightFrames*fInstance.BloomMipmappedArray2DImages[0].MipMapLevels);
 ...
 for InFlightFrameIndex:=0 to FrameGraph.CountInFlightFrames-1 do begin
  ...
  for MipMapLevelIndex:=0 to fInstance.BloomMipmappedArray2DImages[InFlightFrameIndex].MipMapLevels-1 do begin
   ...
   if MipMapLevelIndex=0 then begin
    ...
    fVulkanDescriptorSets[InFlightFrameIndex,MipMapLevelIndex].WriteToDescriptorSet(0,
                                                                                    ...
                                                                                    1,
                                                                                    TVkDescriptorType(VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER),
                                                                                    [TVkDescriptorImageInfo.Create(fInstance.BloomMipmappedArray2DImages[InFlightFrameIndex].VulkanMipMapSampler.Handle,
                                                                                                                   fInstance.BloomMipmappedArray2DImages[InFlightFrameIndex].DescriptorImageInfos[MipMapLevelIndex-1].imageView,
                                                                                                                   VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL)],
                                                                                    [],
                                                                                    [],
                                                                                    false
   ...
   fVulkanDescriptorSets[InFlightFrameIndex,MipMapLevelIndex].WriteToDescriptorSet(1,
                                                                                   ...
                                                                                   [TVkDescriptorImageInfo.Create(fVulkanSampler.Handle,
                                                                                                                  fInstance.BloomMipmappedArray2DImages[InFlightFrameIndex].DescriptorImageInfos[MipMapLevelIndex].imageView,
...
procedure TpvScene3DRendererPassesBloomDownsampleComputePass.ReleaseVolatileResources;
var InFlightFrameIndex,MipMapLevelIndex:TpvInt32;
begin
...
procedure TpvScene3DRendererPassesBloomDownsampleComputePass.Update(const aUpdateInFlightFrameIndex,aUpdateFrameIndex:TpvSizeInt);
begin
 inherited Update(aUpdateInFlightFrameIndex,aUpdateFrameIndex);
end;

procedure TpvScene3DRendererPassesBloomDownsampleComputePass.Execute(const aCommandBuffer:TpvVulkanCommandBuffer;const aInFlightFrameIndex,aFrameIndex:TpvSizeInt);
var InFlightFrameIndex,MipMapLevelIndex:TpvInt32;
...
begin
 ...
 ImageMemoryBarrier.image:=fInstance.BloomMipmappedArray2DImages[InFlightFrameIndex].VulkanImage.Handle;
 ImageMemoryBarrier.subresourceRange.aspectMask:=TVkImageAspectFlags(VK_IMAGE_ASPECT_COLOR_BIT);
 ImageMemoryBarrier.subresourceRange.baseMipLevel:=0;
 ImageMemoryBarrier.subresourceRange.levelCount:=fInstance.BloomMipmappedArray2DImages[InFlightFrameIndex].MipMapLevels;
 ...
 for MipMapLevelIndex:=0 to fInstance.BloomMipmappedArray2DImages[InFlightFrameIndex].MipMapLevels-1 do begin
  ...
  ImageMemoryBarrier.subresourceRange.baseArrayLayer:=0;
  ImageMemoryBarrier.subresourceRange.layerCount:=fInstance.CountSurfaceViews;
  if (MipMapLevelIndex+1)<fInstance.BloomMipmappedArray2DImages[InFlightFrameIndex].MipMapLevels then begin
