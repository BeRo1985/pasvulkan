...
begin
 ...
 Stream:=pvScene3DShaderVirtualFileSystem.GetFile('global_illumination_cascaded_radiance_hints_bounce_comp.spv');
 try
...
{PushConstants.MaximumSamplingDistance:=fInstance.Renderer.GlobalIlluminationRadianceHintsMaximumSamplingDistance;
 ...
 if assigned(fInstance.Renderer.VulkanDevice.BreadcrumbBuffer) then begin
  fInstance.Renderer.VulkanDevice.BreadcrumbBuffer.BeginBreadcrumb(aCommandBuffer.Handle,TpvVulkanBreadcrumbType.Dispatch,'GIRadianceHintsBounce');
 end;
