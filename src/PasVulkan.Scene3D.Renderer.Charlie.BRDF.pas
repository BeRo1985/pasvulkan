 ...
 *                                                                            *
 ******************************************************************************)
unit PasVulkan.Scene3D.Renderer.Charlie.BRDF;
{$i PasVulkan.inc}
{$ifndef fpc}
...
type { TpvScene3DRendererCharlieBRDF }
     TpvScene3DRendererCharlieBRDF=class
      public
       const Width=1024;
             Height=1024;
...
{ TpvScene3DRendererCharlieBRDF }

constructor TpvScene3DRendererCharlieBRDF.Create(const aVulkanDevice:TpvVulkanDevice;const aVulkanPipelineCache:TpvVulkanPipelineCache;const aSampler:TpvVulkanSampler);
...
begin
 ...
 Stream:=pvScene3DShaderVirtualFileSystem.GetFile('brdf_charlie_frag.spv');
 try
...
destructor TpvScene3DRendererCharlieBRDF.Destroy;
begin
