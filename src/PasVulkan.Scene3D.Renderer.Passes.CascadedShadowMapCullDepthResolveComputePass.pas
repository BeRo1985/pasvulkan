 ...
 *                                                                            *
 ******************************************************************************)
unit PasVulkan.Scene3D.Renderer.Passes.CascadedShadowMapCullDepthResolveComputePass;
{$i PasVulkan.inc}
{$ifndef fpc}
...
type { TpvScene3DRendererPassesCascadedShadowMapCullDepthResolveComputePass }
     TpvScene3DRendererPassesCascadedShadowMapCullDepthResolveComputePass=class(TpvFrameGraph.TComputePass)
      public
...
{ TpvScene3DRendererPassesCascadedShadowMapCullDepthResolveComputePass  }

constructor TpvScene3DRendererPassesCascadedShadowMapCullDepthResolveComputePass.Create(const aFrameGraph:TpvFrameGraph;const aInstance:TpvScene3DRendererInstance);
begin
 inherited Create(aFrameGraph);

 fInstance:=aInstance;

 Name:='CascadedShadowMapDepthResolveComputePass';
...
destructor TpvScene3DRendererPassesCascadedShadowMapCullDepthResolveComputePass.Destroy;
begin
 inherited Destroy;
end;

procedure TpvScene3DRendererPassesCascadedShadowMapCullDepthResolveComputePass.AcquirePersistentResources;
var Stream:TStream;
begin
...
procedure TpvScene3DRendererPassesCascadedShadowMapCullDepthResolveComputePass.ReleasePersistentResources;
begin
...
procedure TpvScene3DRendererPassesCascadedShadowMapCullDepthResolveComputePass.AcquireVolatileResources;
...
begin
 ...
 fPipelineLayout.AddPushConstantRange(TVkShaderStageFlags(VK_SHADER_STAGE_COMPUTE_BIT),0,SizeOf(TpvScene3DRendererPassesCascadedShadowMapCullDepthResolveComputePass.TPushConstants));
 ...
 for InFlightFrameIndex:=0 to FrameGraph.CountInFlightFrames-1 do begin
  ...
  begin
   ...
   fVulkanDescriptorSets[InFlightFrameIndex].WriteToDescriptorSet(1,
                                                                  ...
                                                                  [TVkDescriptorImageInfo.Create(fInstance.Renderer.ClampedNearestSampler.Handle,
                                                                                                 fInstance.CascadedShadowMapCullDepthArray2DImage.VulkanImageView.Handle,
...
procedure TpvScene3DRendererPassesCascadedShadowMapCullDepthResolveComputePass.ReleaseVolatileResources;
var InFlightFrameIndex,MipMapLevelIndex:TpvInt32;
begin
...
procedure TpvScene3DRendererPassesCascadedShadowMapCullDepthResolveComputePass.Update(const aUpdateInFlightFrameIndex,aUpdateFrameIndex:TpvSizeInt);
begin
 inherited Update(aUpdateInFlightFrameIndex,aUpdateFrameIndex);
end;

procedure TpvScene3DRendererPassesCascadedShadowMapCullDepthResolveComputePass.Execute(const aCommandBuffer:TpvVulkanCommandBuffer;const aInFlightFrameIndex,aFrameIndex:TpvSizeInt);
var InFlightFrameIndex:TpvInt32;
    ImageMemoryBarrier:TVkImageMemoryBarrier;
    PushConstants:TpvScene3DRendererPassesCascadedShadowMapCullDepthResolveComputePass.TPushConstants;
begin
 ...
 ImageMemoryBarrier.image:=fInstance.CascadedShadowMapCullDepthArray2DImage.VulkanImage.Handle;
 ...
 begin
  ...
  aCommandBuffer.CmdPushConstants(fPipelineLayout.Handle,
                                  ...
                                  0,
                                  SizeOf(TpvScene3DRendererPassesCascadedShadowMapCullDepthResolveComputePass.TPushConstants),
                                  @PushConstants);
