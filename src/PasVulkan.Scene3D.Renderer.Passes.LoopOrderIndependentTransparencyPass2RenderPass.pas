...
type { TpvScene3DRendererInstancePassesLoopOrderIndependentTransparencyPass2RenderPass }
     TpvScene3DRendererInstancePassesLoopOrderIndependentTransparencyPass2RenderPass=class(TpvFrameGraph.TRenderPass)
      private
...
{ TpvScene3DRendererInstancePassesLoopOrderIndependentTransparencyPass2RenderPass }

constructor TpvScene3DRendererInstancePassesLoopOrderIndependentTransparencyPass2RenderPass.Create(const aFrameGraph:TpvFrameGraph;const aInstance:TpvScene3DRendererInstance);
begin
...
destructor TpvScene3DRendererInstancePassesLoopOrderIndependentTransparencyPass2RenderPass.Destroy;
begin
 inherited Destroy;
end;

procedure TpvScene3DRendererInstancePassesLoopOrderIndependentTransparencyPass2RenderPass.Show;
...
//fFrameGraph.VulkanDevice.DebugMarker.SetObjectName(fMeshVertexShaderModule.Handle,TVkDebugReportObjectTypeEXT.VK_DEBUG_REPORT_OBJECT_TYPE_SHADER_MODULE_EXT,'fMeshVertexShaderModule');
 ...
 if fInstance.Renderer.SurfaceSampleCountFlagBits=TVkSampleCountFlagBits(VK_SAMPLE_COUNT_1_BIT) then begin
  if fInstance.ZFar<0.0 then begin
   Stream:=pvApplication.Assets.GetAssetStream('shaders/mesh_'+fInstance.Renderer.MeshFragTypeName+'_'+fInstance.Renderer.MeshFragShadowTypeName+'_loopoit_reversedz_pass2_frag.spv');
  end else begin
   Stream:=pvApplication.Assets.GetAssetStream('shaders/mesh_'+fInstance.Renderer.MeshFragTypeName+'_'+fInstance.Renderer.MeshFragShadowTypeName+'_loopoit_pass2_frag.spv');
  end;
 end else begin
  if fInstance.ZFar<0.0 then begin
   Stream:=pvApplication.Assets.GetAssetStream('shaders/mesh_'+fInstance.Renderer.MeshFragTypeName+'_'+fInstance.Renderer.MeshFragShadowTypeName+'_loopoit_msaa_reversedz_pass2_frag.spv');
  end else begin
   Stream:=pvApplication.Assets.GetAssetStream('shaders/mesh_'+fInstance.Renderer.MeshFragTypeName+'_'+fInstance.Renderer.MeshFragShadowTypeName+'_loopoit_msaa_frag.spv');
  end;
 end;
 try
...
//fFrameGraph.VulkanDevice.DebugMarker.SetObjectName(fMeshFragmentShaderModule.Handle,TVkDebugReportObjectTypeEXT.VK_DEBUG_REPORT_OBJECT_TYPE_SHADER_MODULE_EXT,'fMeshFragmentShaderModule');
 ...
 if fInstance.Renderer.SurfaceSampleCountFlagBits=TVkSampleCountFlagBits(VK_SAMPLE_COUNT_1_BIT) then begin
  if fInstance.ZFar<0.0 then begin
   Stream:=pvApplication.Assets.GetAssetStream('shaders/mesh_'+fInstance.Renderer.MeshFragTypeName+'_'+fInstance.Renderer.MeshFragShadowTypeName+'_loopoit_masked_reversedz_pass2_frag.spv');
  end else begin
   Stream:=pvApplication.Assets.GetAssetStream('shaders/mesh_'+fInstance.Renderer.MeshFragTypeName+'_'+fInstance.Renderer.MeshFragShadowTypeName+'_loopoit_masked_pass2_frag.spv');
  end;
 end else begin
  if fInstance.ZFar<0.0 then begin
   Stream:=pvApplication.Assets.GetAssetStream('shaders/mesh_'+fInstance.Renderer.MeshFragTypeName+'_'+fInstance.Renderer.MeshFragShadowTypeName+'_loopoit_msaa_masked_reversedz_pass2_frag.spv');
  end else begin
   Stream:=pvApplication.Assets.GetAssetStream('shaders/mesh_'+fInstance.Renderer.MeshFragTypeName+'_'+fInstance.Renderer.MeshFragShadowTypeName+'_loopoit_msaa_masked_pass2_frag.spv');
  end;
 end;
 try
...
procedure TpvScene3DRendererInstancePassesLoopOrderIndependentTransparencyPass2RenderPass.Hide;
begin
...
procedure TpvScene3DRendererInstancePassesLoopOrderIndependentTransparencyPass2RenderPass.AfterCreateSwapChain;
...
begin
 ...
 fGlobalVulkanDescriptorPool.AddDescriptorPoolSize(VK_DESCRIPTOR_TYPE_STORAGE_TEXEL_BUFFER,3*fInstance.Renderer.CountInFlightFrames);
...
procedure TpvScene3DRendererInstancePassesLoopOrderIndependentTransparencyPass2RenderPass.BeforeDestroySwapChain;
var Index:TpvSizeInt;
    AlphaMode:TpvScene3D.TMaterial.TAlphaMode;
    PrimitiveTopology:TpvScene3D.TPrimitiveTopology;
    DoubleSided:TpvScene3D.TDoubleSided;
...
procedure TpvScene3DRendererInstancePassesLoopOrderIndependentTransparencyPass2RenderPass.Update(const aUpdateInFlightFrameIndex,aUpdateFrameIndex:TpvSizeInt);
begin
 inherited Update(aUpdateInFlightFrameIndex,aUpdateFrameIndex);
end;

procedure TpvScene3DRendererInstancePassesLoopOrderIndependentTransparencyPass2RenderPass.OnSetRenderPassResources(const aCommandBuffer:TpvVulkanCommandBuffer;
                                                                                                const aPipelineLayout:TpvVulkanPipelineLayout;
                                                                                                const aRenderPassIndex:TpvSizeInt;
                                                                                                const aPreviousInFlightFrameIndex:TpvSizeInt;
                                                                                                const aInFlightFrameIndex:TpvSizeInt);
...
procedure TpvScene3DRendererInstancePassesLoopOrderIndependentTransparencyPass2RenderPass.Execute(const aCommandBuffer:TpvVulkanCommandBuffer;
