 ...
 *                                                                            *
 ******************************************************************************)
unit PasVulkan.Scene3D.Renderer.Passes.PlanetWaterRenderPass;
{$i PasVulkan.inc}
{$ifndef fpc}
...
type { TpvScene3DRendererPassesPlanetWaterRenderPass }
     TpvScene3DRendererPassesPlanetWaterRenderPass=class(TpvFrameGraph.TRenderPass)
      private
...
{ TpvScene3DRendererPassesPlanetWaterRenderPass }

constructor TpvScene3DRendererPassesPlanetWaterRenderPass.Create(const aFrameGraph:TpvFrameGraph;const aInstance:TpvScene3DRendererInstance);
begin
inherited Create(aFrameGraph);

 fInstance:=aInstance;

 Name:='PlanetWaterRenderPass';
...
destructor TpvScene3DRendererPassesPlanetWaterRenderPass.Destroy;
begin
 inherited Destroy;
end;

procedure TpvScene3DRendererPassesPlanetWaterRenderPass.AcquirePersistentResources;
begin
...
procedure TpvScene3DRendererPassesPlanetWaterRenderPass.ReleasePersistentResources;
begin
...
procedure TpvScene3DRendererPassesPlanetWaterRenderPass.AcquireVolatileResources;
...
procedure TpvScene3DRendererPassesPlanetWaterRenderPass.ReleaseVolatileResources;
...
procedure TpvScene3DRendererPassesPlanetWaterRenderPass.Update(const aUpdateInFlightFrameIndex,aUpdateFrameIndex:TpvSizeInt);
begin
 inherited Update(aUpdateInFlightFrameIndex,aUpdateFrameIndex);
end;

procedure TpvScene3DRendererPassesPlanetWaterRenderPass.OnSetRenderPassResources(const aCommandBuffer:TpvVulkanCommandBuffer;
                                                                                        const aPipelineLayout:TpvVulkanPipelineLayout;
                                                                                        const aRendererInstance:TObject;
                                                                                        const aRenderPassIndex:TpvSizeInt;
                                                                                        const aPreviousInFlightFrameIndex:TpvSizeInt;
...
procedure TpvScene3DRendererPassesPlanetWaterRenderPass.Execute(const aCommandBuffer:TpvVulkanCommandBuffer;
