 ...
 *                                                                            *
 ******************************************************************************)
unit PasVulkan.Scene3D.Renderer.Passes.BlitRenderPass;
{$i PasVulkan.inc}
{$ifndef fpc}
...
type { TpvScene3DRendererPassesBlitRenderPass }
      TpvScene3DRendererPassesBlitRenderPass=class(TpvFrameGraph.TRenderPass)
       private
...
{ TpvScene3DRendererPassesBlitRenderPass }


constructor TpvScene3DRendererPassesBlitRenderPass.Create(const aFrameGraph:TpvFrameGraph;const aInstance:TpvScene3DRendererInstance);
begin
...
destructor TpvScene3DRendererPassesBlitRenderPass.Destroy;
begin
 inherited Destroy;
end;

procedure TpvScene3DRendererPassesBlitRenderPass.AcquirePersistentResources;
var Stream:TStream;
begin
...
procedure TpvScene3DRendererPassesBlitRenderPass.ReleasePersistentResources;
begin
...
procedure TpvScene3DRendererPassesBlitRenderPass.AcquireVolatileResources;
...
procedure TpvScene3DRendererPassesBlitRenderPass.ReleaseVolatileResources;
var InFlightFrameIndex:TpvSizeInt;
begin
...
procedure TpvScene3DRendererPassesBlitRenderPass.Update(const aUpdateInFlightFrameIndex,aUpdateFrameIndex:TpvSizeInt);
begin
 inherited Update(aUpdateInFlightFrameIndex,aUpdateFrameIndex);
end;

procedure TpvScene3DRendererPassesBlitRenderPass.Execute(const aCommandBuffer:TpvVulkanCommandBuffer;const aInFlightFrameIndex,aFrameIndex:TpvSizeInt);
