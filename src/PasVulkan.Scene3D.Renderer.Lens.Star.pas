 ...
 *                                                                            *
 ******************************************************************************)
unit PasVulkan.Scene3D.Renderer.Lens.Star;
{$i PasVulkan.inc}
{$ifndef fpc}
...
type { TpvScene3DRendererLensStar }
     TpvScene3DRendererLensStar=class
      public
       const Width=2048;
             Height=2048;
...
{ TpvScene3DRendererLensStar }

constructor TpvScene3DRendererLensStar.Create(const aVulkanDevice:TpvVulkanDevice;const aVulkanPipelineCache:TpvVulkanPipelineCache;const aSampler:TpvVulkanSampler);
...
begin
 ...
 Stream:=pvScene3DShaderVirtualFileSystem.GetFile('lens_star_frag.spv');
 try
...
destructor TpvScene3DRendererLensStar.Destroy;
begin
