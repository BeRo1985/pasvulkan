 ...
 *                                                                            *
 ******************************************************************************)
unit PasVulkan.Scene3D.Renderer.Passes.LockOrderIndependentTransparencyResolveRenderPass;
{$i PasVulkan.inc}
{$ifndef fpc}
...
type { TpvScene3DRendererPassesLockOrderIndependentTransparencyResolveRenderPass }
     TpvScene3DRendererPassesLockOrderIndependentTransparencyResolveRenderPass=class(TpvFrameGraph.TRenderPass)
      private
...
constructor TpvScene3DRendererPassesLockOrderIndependentTransparencyResolveRenderPass.Create(const aFrameGraph:TpvFrameGraph;const aInstance:TpvScene3DRendererInstance);
begin
...
destructor TpvScene3DRendererPassesLockOrderIndependentTransparencyResolveRenderPass.Destroy;
begin
 inherited Destroy;
end;

procedure TpvScene3DRendererPassesLockOrderIndependentTransparencyResolveRenderPass.AcquirePersistentResources;
var Stream:TStream;
begin
 ...
 if fInstance.Renderer.SurfaceSampleCountFlagBits=TVkSampleCountFlagBits(VK_SAMPLE_COUNT_1_BIT) then begin
  if fInstance.Scene3D.EnableWater then begin
   if fInstance.ZFar<0.0 then begin
    Stream:=pvScene3DShaderVirtualFileSystem.GetFile('lockoit_resolve_water_reversedz_frag.spv');
   end else begin
    Stream:=pvScene3DShaderVirtualFileSystem.GetFile('lockoit_resolve_water_frag.spv');
   end;
  end else begin
   if fInstance.ZFar<0.0 then begin
    Stream:=pvScene3DShaderVirtualFileSystem.GetFile('lockoit_resolve_reversedz_frag.spv');
   end else begin
    Stream:=pvScene3DShaderVirtualFileSystem.GetFile('lockoit_resolve_frag.spv');
   end;
  end;
 end else begin
  if fInstance.Scene3D.EnableWater then begin
   if fInstance.Renderer.SupersampleWaterWhenMSAA then begin
    if fInstance.ZFar<0.0 then begin
     Stream:=pvScene3DShaderVirtualFileSystem.GetFile('lockoit_resolve_water_reversedz_msaa_frag.spv');
    end else begin
     Stream:=pvScene3DShaderVirtualFileSystem.GetFile('lockoit_resolve_water_msaa_frag.spv');
    end;
   end else begin
    if fInstance.ZFar<0.0 then begin
     Stream:=pvScene3DShaderVirtualFileSystem.GetFile('lockoit_resolve_water_reversedz_msaa_no_msaa_water_frag.spv');
    end else begin
     Stream:=pvScene3DShaderVirtualFileSystem.GetFile('lockoit_resolve_water_msaa_no_msaa_water_frag.spv');
    end;
   end;
  end else begin
   if fInstance.ZFar<0.0 then begin
    Stream:=pvScene3DShaderVirtualFileSystem.GetFile('lockoit_resolve_reversedz_msaa_frag.spv');
   end else begin
    Stream:=pvScene3DShaderVirtualFileSystem.GetFile('lockoit_resolve_msaa_frag.spv');
   end;
  end;
 end;
 try
...
procedure TpvScene3DRendererPassesLockOrderIndependentTransparencyResolveRenderPass.ReleasePersistentResources;
begin
...
procedure TpvScene3DRendererPassesLockOrderIndependentTransparencyResolveRenderPass.AcquireVolatileResources;
...
procedure TpvScene3DRendererPassesLockOrderIndependentTransparencyResolveRenderPass.ReleaseVolatileResources;
var InFlightFrameIndex:TpvSizeInt;
begin
...
procedure TpvScene3DRendererPassesLockOrderIndependentTransparencyResolveRenderPass.Update(const aUpdateInFlightFrameIndex,aUpdateFrameIndex:TpvSizeInt);
begin
 inherited Update(aUpdateInFlightFrameIndex,aUpdateFrameIndex);
end;

procedure TpvScene3DRendererPassesLockOrderIndependentTransparencyResolveRenderPass.Execute(const aCommandBuffer:TpvVulkanCommandBuffer;const aInFlightFrameIndex,aFrameIndex:TpvSizeInt);
begin
 ...
 if assigned(fInstance.Renderer.VulkanDevice.BreadcrumbBuffer) then begin
  fInstance.Renderer.VulkanDevice.BreadcrumbBuffer.BeginBreadcrumb(aCommandBuffer.Handle,TpvVulkanBreadcrumbType.Draw,'LockOITResolve');
 end;
