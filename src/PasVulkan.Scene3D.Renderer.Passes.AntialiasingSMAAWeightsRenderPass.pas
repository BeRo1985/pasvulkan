 ...
 *                                                                            *
 ******************************************************************************)
unit PasVulkan.Scene3D.Renderer.Passes.AntialiasingSMAAWeightsRenderPass;
{$i PasVulkan.inc}
{$ifndef fpc}
...
procedure TpvScene3DRendererPassesAntialiasingSMAAWeightsRenderPass.AcquirePersistentResources;
var Stream:TStream;
begin
 ...
 Stream:=pvScene3DShaderVirtualFileSystem.GetFile('antialiasing_smaa_weights_vert.spv');
 try
 ...
 Stream:=pvScene3DShaderVirtualFileSystem.GetFile('antialiasing_smaa_weights_frag.spv');
 try
...
procedure TpvScene3DRendererPassesAntialiasingSMAAWeightsRenderPass.ReleasePersistentResources;
begin
...
procedure TpvScene3DRendererPassesAntialiasingSMAAWeightsRenderPass.AcquireVolatileResources;
...
begin
 ...
 for InFlightFrameIndex:=0 to FrameGraph.CountInFlightFrames-1 do begin
  ...
  fVulkanDescriptorSets[InFlightFrameIndex].WriteToDescriptorSet(1,
                                                                 ...
                                                                 TVkDescriptorType(VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER),
                                                                 [TVkDescriptorImageInfo.Create(fVulkanSampler.Handle,
                                                                                                fInstance.Renderer.SMAAAreaTexture.ImageView.Handle,
  ...
  fVulkanDescriptorSets[InFlightFrameIndex].WriteToDescriptorSet(2,
                                                                 ...
                                                                 TVkDescriptorType(VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER),
                                                                 [TVkDescriptorImageInfo.Create(fVulkanSampler.Handle,
                                                                                                fInstance.Renderer.SMAASearchTexture.ImageView.Handle,
                                                                                                TVkImageLayout(VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL))],
                                                                 [],
                                                                 [],
                                                                 false
...
procedure TpvScene3DRendererPassesAntialiasingSMAAWeightsRenderPass.ReleaseVolatileResources;
var InFlightFrameIndex:TpvSizeInt;
begin
