   ...
   case fWhich of
    0:begin
     fVulkanDescriptorSets[InFlightFrameIndex,MipMapLevelIndex].WriteToDescriptorSet(1,
                                                                                     ...
                                                                                     [TVkDescriptorImageInfo.Create(fVulkanSampler.Handle,
                                                                                                                    fInstance.ImageBasedLightingReflectionProbeCubeMaps.GGXDescriptorImageInfos[InFlightFrameIndex].imageView,
    ...
    1:begin
     fVulkanDescriptorSets[InFlightFrameIndex,MipMapLevelIndex].WriteToDescriptorSet(1,
                                                                                     ...
                                                                                     TVkDescriptorType(VK_DESCRIPTOR_TYPE_STORAGE_IMAGE),
                                                                                     [TVkDescriptorImageInfo.Create(fVulkanSampler.Handle,
                                                                                                                    fInstance.ImageBasedLightingReflectionProbeCubeMaps.CharlieDescriptorImageInfos[InFlightFrameIndex].imageView,
                                                                                                                    VK_IMAGE_LAYOUT_GENERAL)],
                                                                                     [],
                                                                                     [],
                                                                                     false
     ...
     fVulkanDescriptorSets[InFlightFrameIndex,MipMapLevelIndex].WriteToDescriptorSet(1,
                                                                                     ...
                                                                                     TVkDescriptorType(VK_DESCRIPTOR_TYPE_STORAGE_IMAGE),
                                                                                     [TVkDescriptorImageInfo.Create(fVulkanSampler.Handle,
                                                                                                                    fInstance.ImageBasedLightingReflectionProbeCubeMaps.LambertianDescriptorImageInfos[InFlightFrameIndex].imageView,
                                                                                                                    VK_IMAGE_LAYOUT_GENERAL)],
                                                                                     [],
                                                                                     [],
                                                                                     false
