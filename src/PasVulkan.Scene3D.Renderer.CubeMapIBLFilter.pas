...
constructor TpvScene3DRendererCubeMapIBLFilter.Create(const aFrameGraph:TpvFrameGraph;const aInstance:TpvScene3DRendererInstance;const aWhich:TpvSizeInt);
begin
...
procedure TpvScene3DRendererCubeMapIBLFilter.Update(const aUpdateInFlightFrameIndex,aUpdateFrameIndex:TpvSizeInt);
begin
 inherited Update(aUpdateInFlightFrameIndex,aUpdateFrameIndex);
end;

procedure TpvScene3DRendererCubeMapIBLFilter.Execute(const aCommandBuffer:TpvVulkanCommandBuffer;const aInFlightFrameIndex,aFrameIndex:TpvSizeInt);
const Samples=128;
var InFlightFrameIndex,MipMapLevelIndex:TpvInt32;
