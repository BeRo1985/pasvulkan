...
begin
 ...
 if LZBRSFCompress(OriginalData,OriginalSize,CompressedOriginalData,CompressedOriginalSize,TpvLZBRSFLevel(5),false) then begin
  if LZBRSFDecompress(CompressedOriginalData,CompressedOriginalSize,UncompressedCompressedData,UncompressedCompressedSize,OriginalSize,false) then begin
