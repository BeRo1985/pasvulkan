...
constructor TVulkanTexture.CreateFromJPEG(const pDevice:TVulkanDevice;
                                          ...
                                          const pMipMaps:boolean);
const MipMapLevels:array[boolean] of TVkInt32=(1,-1);
 function LoadJPEGImage(DataPointer:pointer;DataSize:TVkUInt32;var ImageData:pointer;var ImageWidth,ImageHeight:TVkInt32):boolean;
...
begin
 ...
 try
  ...
  ImageHeight:=0;
  try
   if LoadJPEGImage(Data,DataSize,ImageData,ImageWidth,ImageHeight) then begin
    CreateFromMemory(pDevice,
                     pGraphicsCommandBuffer,
                     pGraphicsFence,
                     pTransferCommandBuffer,
